<%@ Page Title="HTF Foil Use" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="HTF-Print.aspx.cs" Inherits="app_HTF_Print" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function calInvTotal() {
            ...
            var htfUseQuantity = document.getElementById("<%= txtHTFUseQuantity.ClientID %>").value;
            var rejUsed = document.getElementById("<%= txtWeightPc.ClientID %>").value;
            var ttl = parseFloat(rejUsed * 1) * parseFloat(shtQty / 1000);
            var htfRejectQuantity = parseFloat(htfUseQuantity * 1) - parseFloat(shtQty * 1);
            $('#<%=txtInputWeight.ClientID%>').val(ttl.toString());
            $('#<%=txtHTFRejectQuantity.ClientID%>').val(htfRejectQuantity.toString());
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">HTF Foil Use</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="portlet box red">
                        ...
                        <div class="control-group">
                            <asp:Label ID="Label5" runat="server" Text="HTF Foil Name: "></asp:Label>
                            <asp:DropDownList ID="ddHTFFoil" runat="server" DataSourceID="SqlDataSource2"
                                DataTextField="ItemName" DataValueField="ProductID" CssClass="form-control">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                SelectCommand="SELECT dbo.ItemSubGroup.CategoryID AS SubGroupID, dbo.ItemGrade.GradeID, dbo.ItemGrade.GradeName, dbo.Categories.CategoryID, dbo.Categories.CategoryName, dbo.Products.ProductID, CONCAT(dbo.Products.ItemName,'>>',dbo.ItemGrade.GradeName,'>>',dbo.Categories.CategoryName) AS ItemName, 
                         dbo.Products.UnitType, dbo.Products.Description, dbo.Products.SalePrice, dbo.Products.PurchasePrice, dbo.Products.Weight FROM  dbo.ItemSubGroup 
                                INNER JOIN dbo.ItemGrade ON dbo.ItemSubGroup.CategoryID = dbo.ItemGrade.CategoryID 
                                INNER JOIN dbo.Categories ON dbo.ItemGrade.GradeID = dbo.Categories.GradeID 
                                INNER JOIN dbo.Products ON dbo.Categories.CategoryID = dbo.Products.CategoryID WHERE dbo.ItemSubGroup.CategoryID = '33'"></asp:SqlDataSource>
                        </div>
                        <div class="control-group">
                            <asp:Label ID="Label6" runat="server" Text="HTF Use (Qty): "></asp:Label>
                            <asp:TextBox ID="txtHTFUseQuantity" runat="server" onkeyup="calInvTotal()"></asp:TextBox>
                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2"
                                runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789" TargetControlID="txtInputQtyPCS">
                            </asp:FilteredTextBoxExtender>
                        </div>
                        <div class="control-group">
                            <asp:Label ID="Label7" runat="server" Text="HTF Reject (Qty): "></asp:Label>
                            <asp:TextBox ID="txtHTFRejectQuantity" runat="server" onkeyup="calInvTotal()"></asp:TextBox>
