<%@ Page Title="Shareholders Equity" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Changes-in-Equity.aspx.cs" Inherits="app_ShareholderEquity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Statement of Changes in Equity</h3>
                                            ...
                                            <td>
                                                <div class="control-group">
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:qpailerpConnectionString %>"
                                                        SelectCommand="SELECT        TOP
                             (SELECT        COUNT(Financial_Year_Number) - 2 AS Expr1
                               FROM            tblFinancial_Year) Financial_Year_Number, Financial_Year
FROM            tblFinancial_Year AS tblFinancial_Year_1
ORDER BY Financial_Year_Number DESC"></asp:SqlDataSource>
                                                </div>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" width="60%" style="width: 60%" class="table1">
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle; text-align: right;"><b>Financial Year:</b></td>
                                            <td>
