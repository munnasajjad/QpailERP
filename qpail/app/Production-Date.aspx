<%@ Page Title="Screen Print Production by Date" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Production-Date.aspx.cs" Inherits="app_Production_Date" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Screen Print Production by Date
                    </div>
                    <div class="tools">
