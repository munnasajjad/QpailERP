<%@ Page Title="Item Grades" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Item-Grade.aspx.cs" Inherits="app_Item_Grade" %>
			...
			<div class="row">
				...
				<div class="col-md-6 ">
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Grade/Sections Setup
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
								...
								<div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT GroupSrNo,[GroupName] FROM [ItemGroup] ORDER BY [GroupSrNo]"></asp:SqlDataSource>
									</div>
                                    ...
                                    <div class="form-group">
										...
										<asp:TextBox ID="txtDept" runat="server" CssClass="form-control" EnableViewState="true" placeholder="Grade Name" />									
									</div>
                ...
                <asp:TemplateField ItemStyle-Width="40px">
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sub-group" SortExpression="GroupN" >                            
                            <ItemTemplate>
