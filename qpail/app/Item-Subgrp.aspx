<%@ Page Title="Items Sub-Group" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Item-Subgrp.aspx.cs" Inherits="app_Item_Subgrp" %>
			...
			<div class="row">
				...
				<div class="col-md-6 ">
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Items Sub-group Setup
							</div>
							<div class="tools">
                ...
                <asp:TemplateField ItemStyle-Width="40px">
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sub-Group" SortExpression="CategoryName">
                            <ItemTemplate>
