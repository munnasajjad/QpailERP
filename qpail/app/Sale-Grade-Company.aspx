<%@ Page Title="Sales by Grade Company" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Sale-Grade-Company.aspx.cs" Inherits="app_Sale_Grade_Company" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box light-grey" style="min-height: 355px;">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Sales by Grade & Company
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body col-md-12 table-responsive">
                                ...
                                <asp:GridView ID="GVrpt" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info"
                                    runat="server" AutoGenerateColumns="False" PageSize="20" AllowPaging="True"
