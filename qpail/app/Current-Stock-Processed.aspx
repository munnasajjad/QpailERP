<%@ Page Title="Current Stock (Processed)" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Current-Stock-Processed.aspx.cs" Inherits="Current_Stock_Processed" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Current Stock (Processed)
                    </div>
                    <div class="tools">
                                        ...
                                        <div class="col-md-4 hidden">
                                            <div class="control-group">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT GroupSrNo, [GroupName] FROM [ItemGroup] WHERE GroupSrNo=3 ORDER BY [GroupSrNo]"></asp:SqlDataSource>
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                <div style="margin-top: 29px">
                                                    ...
                                                    <asp:Button ID="btnExport" runat="server" Width="100px" Text="Export Excel" OnClick="btnExport_OnClick" />
                                                    <%--<asp:Button ID="btnPrint" runat="server" Width="100px" Text="Print" OnClick="btnPrint_OnClick" />--%>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="True" OnRowDataBound="ItemGrid_RowDataBound" CssClass="tbl_default zebra table" Font-Names="Arial, Sans-serif" Visible="False">
