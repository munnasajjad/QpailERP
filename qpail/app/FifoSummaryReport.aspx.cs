...
public partial class app_FifoSummaryReport : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string url = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") +
            "XerpReports/FifoSummaryReport.aspx?item=" + ddItemName.SelectedValue + "&brand=" + ddBrand.SelectedValue + "&size=" + ddSize.SelectedValue + "&color=" + ddColor.SelectedValue + "&transactionType=" + ddTransactionType.SelectedValue + "&godown=" + ddGodown.SelectedValue + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo;
