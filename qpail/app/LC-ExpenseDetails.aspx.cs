...
public partial class app_LC_ExpenseDetails : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            if (Convert.ToDateTime(txtDateFrom.Text) <= Convert.ToDateTime(txtDateTo.Text))
            {
                ...
                {
                    string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormLCExpenseDetails.aspx?item=" + ddParties.SelectedValue + "&dt1=" + dt1 + "&dt2=" + dt2;
                    if1.Attributes.Add("src", urlx);
                }
