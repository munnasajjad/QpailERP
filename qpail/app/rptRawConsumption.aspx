<%@ Page Title="Raw Material Consumption Report" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="rptRawConsumption.aspx.cs" Inherits="app_rptRawConsumption" %>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Raw Material Consumption History
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="row">
                                            ...
                                            <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnSearch">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] where (GroupID = 1) OR  (GroupID = 7)">
                                                            <SelectParameters>
                                                ...
                                                <div class="col-md-4" runat="server">
                                                    <div class="control-group">
                                                        <label class="control-label full-wdth"> Date From-To : </label>
                                                        <asp:TextBox ID="txtDate" runat="server" CssClass="form-control col-md-6" Width="50%" placeholder="DD/MM/YYYY"></asp:TextBox>
                                                        <asp:TextBox ID="txtDateTo" runat="server" CssClass="form-control col-md-6"  Width="50%" placeholder="DD/MM/YYYY"></asp:TextBox>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="table-responsive">
                                <legend>Raw Items Issued From Store </legend>

                                <asp:GridView ID="GridView2" runat="server" DataSourceID="InkGridSqlDataSource" AutoGenerateColumns="False" CssClass="table" Width="100%"
                                    AllowSorting="True" Visible="False">
                                    <Columns>
                                ...
                                <asp:SqlDataSource ID="PrintedGridSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT DISTINCT ProductID,(SELECT StoreName FROM Warehouses WHERE (WID = Stock.WarehouseID)) AS Warehouse,
                                                             ...
                                                             (SELECT        CategoryID
                                                               ...
                                                               WHERE        (GradeID IN
                                                                                             (SELECT        GradeID
                                                                                               FROM            ItemGrade
                                                                                               WHERE        (CategoryID = '8'))))))
                                                                 GROUP BY WarehouseID, Purpose, ProductID"></asp:SqlDataSource>
