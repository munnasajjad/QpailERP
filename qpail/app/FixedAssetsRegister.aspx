<%@ Page Title="Fixed Assets Register" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="FixedAssetsRegister.aspx.cs" Inherits="app_FixedAssetlist" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Fixed Assets Register
                    </div>
                    <div class="tools">
