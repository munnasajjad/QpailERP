...
public partial class app_Invoice_Date_Range : System.Web.UI.Page
{
    ...
    private DataTable search()
    {
        try
        {
            ...
            DataSet ds = SQLQuery.ReturnDataSet(@"SELECT SaleID, InvNo, '" + url + "'+InvNo as link, InvDate, SalesMode, CustomerID, CustomerName, PONo," +
                                                " (Select OrderDate from Orders where OrderID=Sales.PONo) as PODate, Period, DeliveryDate, DeliveryTime, DeliveryLocation, TransportDetail, " +
                         ...
                         " EntryBy, EntryDate, IsActive, OverDueDate, InWords, Warehouse, VatChalNo, VatChalDate FROM [Sales] WHERE SaleID<>0 " + query + " ORDER BY InvNo");
