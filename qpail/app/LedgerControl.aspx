<%@ Page Title="Control Accounts Ledger"   UICulture="bn-BD" Culture="bn-BD"  Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LedgerControl.aspx.cs" Inherits="app_LedgerControl" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <h3 class="page-title">
        <asp:Literal ID="ltrFrmName" runat="server" Text="Control Accounts Ledger" />
    </h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet box red">
                ...
                <div id="qPanel">
                    <div id="datePanel">
                        <asp:Label ID="Label2" runat="server" Text="Control A/C Name :"></asp:Label>
    ...
    <asp:Button ID="btnPrint" runat="server" Text="Print" Visible="False" OnClick="btnPrint_OnClick" class="btn btn-s-md btn-primary"/>
