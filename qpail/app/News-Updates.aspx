<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="News-Updates.aspx.cs" Inherits="AdminCentral_News_Updates" %>
            ...
            <div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>News update to show on Dashboard</h6>
					</div>
							...
							<ul>
								...
								<div class="form_grid_12">
									...
									<li>
								        <div class="form_grid_12">
									        ...
									        <div class="form_input">
                                                <asp:TextBox ID="InvNo" ReadOnly="true" runat="server" tabindex="1" class="tip_top"  title="Order ID" ></asp:TextBox>										        									            
								...
								<div class="form_grid_12">
									<div class="form_input">
									    ...
									    <asp:Button ID="btnSave" runat="server" Text="Re-Sent Booking SMS" TabIndex="11"
