...
public partial class app_StockLedger : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormCurrent-Stock-Raw.aspx?godown=" + ddGodown.SelectedValue + "&location=" + ddLocation.SelectedValue + "&purpos=" + ddPurpose.SelectedValue + "&subgro=" + ddSubGroup.SelectedValue + "&Grade =" + ddGrade.SelectedValue + "&Category=" + ddcategory.SelectedValue + "&Type=" + ddType.SelectedValue + "&dt1=" + dateForm + "&dateTo=" + dateTo;
