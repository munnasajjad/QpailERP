...
public partial class app_DepRepo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            txtdateFrom.Text = "01/" + DateTime.Now.AddYears(-1).AddMonths(-1).ToString("MM/yyyy");
    ...
    protected void btnSearch_OnClick(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormDepreciationReport.aspx?dateFrom=" + dt1 + "&dateTo=" + dt2 +"&rptype="+ reporttype;
