...
public partial class app_MachineWiseProduction : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string url = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") +
            "XerpReports/FormDailyPrdn.aspx?machineNo=" + ddMachineNo.SelectedValue + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&type=detail";
...
FROM StockinDetailsRaw WHERE GodownID='" + ddGodown.SelectedValue + "' AND EntryBy=@EntryBy AND OrderID='' AND StockType='Raw'  ORDER BY Id", new SqlConnection(ConfigurationManager.ConnectionStrings["LocalSqlServer"].ConnectionString));
    ...
    protected void btnExport_OnClick(object sender, EventArgs e)
    {
        ...
        string url = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") +
            "XerpReports/FormDailyPrdn.aspx?machineNo=" + ddMachineNo.SelectedValue + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&type=summery";
    ...
    protected void btnAllShift_OnClick(object sender, EventArgs e)
    {
        ...
        string url = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") +
            "XerpReports/DailyPrdnAllShift.aspx?machineNo=" + ddMachineNo.SelectedValue + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&type=AllShift";
