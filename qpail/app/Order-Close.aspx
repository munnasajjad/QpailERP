<%@ Page Title="Close PO" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Order-Close.aspx.cs" Inherits="app_Order_Close" %>
            ...
            <div class="row">
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Close/Re-Open PO
                            </div>
                            <div class="tools">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">What to do :  </label>
                                        <div class="controls">
                                            <asp:RadioButton ID="rbClose" runat="server" Checked="True" GroupName="g" Text="Close PO/LC" AutoPostBack="True" OnCheckedChanged="rbClose_OnCheckedChanged" />
                                            <asp:RadioButton ID="rbReopen" runat="server" Checked="False" GroupName="g" Text="Re-Open PO/LC"  AutoPostBack="True" OnCheckedChanged="rbClose_OnCheckedChanged" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">PO/LC No. : </label>
                                        <div class="controls">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                SelectCommand="SELECT [OrderID] FROM [Orders] WHERE CustomerName=@CustomerName AND ([DeliveryStatus] = @DeliveryStatus) AND OrderType='PO'">
                                                <SelectParameters>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" Enabled="false" placeholder="DD/MM/YYYY"></asp:TextBox>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtDeliveryDate" runat="server" Enabled="false" CssClass="form-control" placeholder="DD/MM/YYYY"></asp:TextBox>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtAddress" runat="server" Enabled="false" CssClass="form-control" placeholder="" />
                                        </div>
                                    </div>
                ...
                <div class="col-md-8 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Items in PO
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                            ...
                                            <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnAdd" Visible="false">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group bottom_fix" style="margin-bottom: -15px !important;">
                                                        ...
                                                        <asp:DropDownList ID="ddCategory" runat="server" DataSourceID="SqlDataSource7"
                                    ...
                                    Total Weight: <asp:Literal ID="ltrWeight" runat="server"></asp:Literal> gm.
                                        ...
                                        <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-bordered"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Delivered Qnty">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbliQtyD" runat="server" Text='<%# Bind("DeliveredQty") %>' ></asp:Label>
                                                    </ItemTemplate>                                                    
                                                    <ItemStyle Width="10%" />
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Balance Qnty">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbliQtyB" runat="server" Text='<%# Bind("QtyBalance") %>' ></asp:Label>
                                                    </ItemTemplate>                                                    
                                                    <ItemStyle Width="10%" />
                                                </asp:TemplateField>
