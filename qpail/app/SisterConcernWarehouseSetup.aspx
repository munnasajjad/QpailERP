<%@ Page Title="Sister Concern Warehouse Setup" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="SisterConcernWarehouseSetup.aspx.cs" Inherits="app_SisterConcernWarehouseSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">Sister Concern Warehouses
                    </h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 ">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Store/Sister Concern Warehouses Setup
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT [WID], Zone, [StoreName], Address, Owner, Description, [ProjectID] FROM [Warehouses] Where IsSisterConcern = '1' AND ProjectID=@ProjectID ORDER BY [WID]">
                                    <SelectParameters>
