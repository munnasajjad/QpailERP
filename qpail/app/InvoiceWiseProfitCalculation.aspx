<%@ Page Title="Invoice Wise Profit" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="InvoiceWiseProfitCalculation.aspx.cs" Inherits="app_InvoiceWiseProfitCalculation" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Invoice Wise Profit
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="True" SelectedRowStyle-BackColor="LightBlue"
                            CssClass="tbl_default zebra table" Visible="False">
