<%@ Page Title="Collection Adjustment" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="CollectionAdjustment.aspx.cs" Inherits="app_CollectionAdjustment" %>
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <%--<asp:Label ID="lblDeptName" runat="server" Text="Adjustment From: "></asp:Label>--%>
                            <label class="control-label">Adjustment From: </label>
                        ...
                        <div class="control-group" id="div1" runat="server">
                            <asp:Label ID="Label11" runat="server" Text="Advance Balance : "></asp:Label>
                            <asp:TextBox ID="txtAdvanceBalance" runat="server" Text="0" ReadOnly="true"></asp:TextBox>
                        </div>
                        ...
                        <div class="control-group" id="divOrders" runat="server">
                            ...
                            <asp:ListBox ID="lvOrders" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource6"
                                ...
                                OnSelectedIndexChanged="lbOrders_SelectedIndexChanged" SelectionMode="Multiple" Height="150px">
                            </asp:ListBox>
                            ...
                            <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="InvoiceNo" GridLines="Vertical">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="TDS Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="lblTDSRate" runat="server" Text='<%# Bind("TDSRate") %>' Width="100px" CssClass="val1"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="VDS Rate">
                                        <ItemTemplate>
                                            <asp:TextBox ID="lblVDSRate" runat="server" Text='<%# Bind("VDSRate") %>' Width="50px" CssClass="val2"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
...
<%--                        <div class="control-group">
                        ...
                        <div class="control-group" runat="server" id="divInvcDueAmt">
                            <asp:Label ID="Label10" runat="server" Text="Adjustable Amount : "></asp:Label>
                            <asp:TextBox ID="txtInvTotal" runat="server" OnTextChanged="txtInvTotal_TextChanged" Text="0"></asp:TextBox>
                        </div>

                        <div class="control-group hidden" runat="server" id="divPaidAmt"> 
                        ...
                        <div class="control-group" runat="server" id="divAdjAmt">
                            <asp:Label ID="Label12" runat="server" Text="Bad Debt (-) : "></asp:Label>
                        ...
                        <div class="control-group">
                            <asp:Label ID="Label18" runat="server" Text="Balance Adjusted Amount : "></asp:Label>
