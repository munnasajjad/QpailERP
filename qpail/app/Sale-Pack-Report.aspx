<%@ Page Title="Sale by Pack-Size" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Sale-Pack-Report.aspx.cs" Inherits="app_Sale_Pack_Report" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box light-grey" style="min-height: 355px;">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Sale by Pack-Size
                            </div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GridView1_OnPageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="20px">
                                    ...
                                    <ItemStyle Width="20px" />
                                        ...
                                        <asp:BoundField DataField="InvDate" HeaderText="Inv. Date" SortExpression="Six2Nine" />
