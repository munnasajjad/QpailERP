<%@ Page Title="Balance Sheet" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="BalanceSheet.aspx.cs" Inherits="app_BalanceSheet" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Statement of Financial Position</h3>
                        ...
                        <div id="Div2">
                            <div>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" width="61%" style="width: 61%" class="table1">
                                        <%--<tr>
                                        ...
                                        <tr>
                                           <td style="vertical-align: middle; text-align: right;"><b> As on Date: </b>
                                                <asp:TextBox ID="txtdateFrom" runat="server" CssClass="form-control" Visible="False"></asp:TextBox>
                                ...
                                <fieldset>
                                    <%--<legend>Search Terms</legend>--%>
                                    <table border="0" width="59%" style="width: 59%" class="table1">
                                        <%--<tr>
