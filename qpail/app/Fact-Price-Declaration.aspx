<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Fact-Price-Declaration.aspx.cs" Inherits="app_Fact_Price_Declaration" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">
                        <asp:Literal ID="ltrPageTitle" runat="server" Text="Price Declarations"></asp:Literal>
                    </h3>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="control-group">
                                        ...
                                        <div class="form_input">
                                            ...
                                            <asp:HtmlEditorExtender TargetControlID="txtMsgBody" runat="server" />
                                        </div>
                                    </div>
                                </div>
