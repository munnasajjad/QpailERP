<%@ Page Title="Requisition Approval" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="RequisitionApproval.aspx.cs" Inherits="app_RequisitionApproval" %>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    <div class="control">
                                        <label class="control-label full-wdth">Issue Item : </label>
                                        <asp:DropDownList ID="ddIssueItem" Width="100%" runat="server" DataSourceID="SqlDataSource16"
                                            DataTextField="OrderID" DataValueField="Stockinl" CssClass="select2me"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddIssueItem_OnSelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource16" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                            SelectCommand="SELECT S.Stockinl, CONCAT(S.OrderID,' - ',W.AreaName) AS OrderID FROM Stockin AS S LEFT JOIN WareHouseAreas AS W ON S.ToLocationID = W.AreaID WHERE (S.Status='Issue') AND S.ApprovalStatus='Not Approved' ORDER BY Stockinl DESC"></asp:SqlDataSource>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label full-wdth">Requistion Date : </label>
                                        <div class="controls">
                                            <asp:TextBox ID="txtDate" runat="server" Enabled="False" ReadOnly="True" CssClass="form-control" placeholder="DD/MM/YYYY"></asp:TextBox>
                                ...
                                <asp:DropDownList ID="ddRemark" runat="server"  CssClass="form-control">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <asp:DropDownList ID="ddFromGodown" runat="server"  DataSourceID="SqlDataSource7" 
                                            DataTextField="StoreName" DataValueField="WID" CssClass="form-control" Enabled="False" ReadOnly="true"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <asp:DropDownList ID="ddFromLocation" runat="server" DataSourceID="SqlDataSource17" Enabled="False" ReadOnly="true"
                                    ...
                                    <div class="control-group" >
                                        ...
                                        <asp:TextBox ID="txtRemarks" runat="server" Enabled="False" ReadOnly="true" CssClass="form-control" placeholder=""></asp:TextBox>
                ...
                <div class="col-md-8 ">
                    ...
                    <div class="portlet box green ">
                        ...
                        <div class="portlet-body form">
                                        ...
                                        <div class="row">
                                            <asp:Panel ID="Panel1" Visible="False" runat="server">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GridView2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info"
                                                        runat="server" AutoGenerateColumns="False" Width="100%" ShowFooter="False" GridLines="Vertical"
                                                        RowStyle-CssClass="odd gradeX">
                                                        <Columns>
                                                            <asp:TemplateField ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <%#Container.DataItemIndex+1 %>
                                                                    <asp:TextBox ID="txtID" runat="server" Text='<%# Bind("Id") %>' Visible="False"></asp:TextBox>
                                                                    <%--<asp:TextBox ID="txtRID" runat="server" Text='<%# Bind("ReqId") %>' Visible="False"></asp:TextBox>
                                                                    <asp:TextBox ID="txtContactID" runat="server" Text='<%# Bind("Contact") %>' Visible="False"></asp:TextBox>
                                                                    <asp:TextBox  ID="txtEpoID" runat="server" Text='<%# Bind("Epo") %>' Visible="False"></asp:TextBox>--%>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Available Qty" SortExpression="Bag" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtManufacturer" runat="server" Text='<%# Bind("Manufacturer") %>' ReadOnly="True" Width="60px" CssClass="val1"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Quantity" SortExpression="Quantity" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtQty" runat="server" ReadOnly="True" Text='<%# Bind("Quantity") %>' Width="60px" CssClass="val2"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Weight" SortExpression="Weight" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtWeight" runat="server" Text='<%# Bind("UnitWeight") %>' AutoPostBack="true" Width="60px" CssClass="val5"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                ...
                                                <div class="col-md-4 hidden">
                                                    <div class="control-group">
                                                        <label>Purpose :</label>
                                                        <asp:DropDownList ID="ddPurpose" runat="server" Enabled="False" ReadOnly="true" DataSourceID="SqlDataSource13"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddGroup" runat="server" Enabled="False" ReadOnly="true" DataSourceID="SqlDataSource1" AutoPostBack="true"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddSubGroup" runat="server" Enabled="False" ReadOnly="true" DataSourceID="SqlDataSource3" DataTextField="CategoryName" DataValueField="CategoryID"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddGrade" Enabled="False" ReadOnly="true" runat="server" DataSourceID="SqlDataSource5"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddCategory" Enabled="False" ReadOnly="true" runat="server" DataSourceID="SqlDataSource8"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddProduct" Enabled="False" ReadOnly="true" runat="server" DataSourceID="SqlDataSource4"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:TextBox ID="txtDesc" runat="server" Enabled="False" ReadOnly="true" CssClass="form-control" placeholder=""></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4" id="ddTypeArea" runat="server">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddType" runat="server" Enabled="False" ReadOnly="true" AutoPostBack="True" OnSelectedIndexChanged="ddType_OnSelectedIndexChanged">
                                            ...
                                            <asp:Panel ID="pnlAdd" runat="server">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GVrpt" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info"
                                                        runat="server" AutoGenerateColumns="False" Width="100%" ShowFooter="False" GridLines="Vertical"  AutoPostBack="True"
                                                        RowStyle-CssClass="odd gradeX" OnRowDataBound="GVrpt_OnRowDataBound" OnSelectedIndexChanged="GVrpt_OnSelectedIndexChanged">
                                                        <Columns>
                                                            <asp:TemplateField ItemStyle-Width="20px">
                                                                <ItemTemplate>
                                                                    <%#Container.DataItemIndex+1 %>
                                                                    <asp:Label ID="txtID" runat="server" Text='<%# Bind("Id") %>' Visible="False"></asp:Label>
                                                                    <%--<asp:TextBox ID="txtRID" runat="server" Text='<%# Bind("ReqId") %>' Visible="False"></asp:TextBox>
                                                                    <asp:TextBox ID="txtContactID" runat="server" Text='<%# Bind("Contact") %>' Visible="False"></asp:TextBox>
                                                                    <asp:TextBox  ID="txtEpoID" runat="server" Text='<%# Bind("Epo") %>' Visible="False"></asp:TextBox>--%>
                                                                </ItemTemplate>
                                                            ...
                                                            <%-- <asp:TemplateField HeaderText="Product Id" Visible="False" ItemStyle-Width="50%">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblProduct" runat="server" Text='<%# Bind("ProductID") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>--%>
                                                            ...
                                                            <asp:TemplateField HeaderText="Description" Visible="False" SortExpression="Manufacturer" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtManufacturer" runat="server" ReadOnly="True" Text='<%# Bind("Manufacturer") %>' Width="60px" CssClass="val2"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Quantity" SortExpression="Quantity" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtQty" runat="server" Text='<%# Bind("Quantity") %>' ReadOnly="True" Width="60px" CssClass="val1"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Weight" SortExpression="Weight" ItemStyle-Width="80px">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtWeight" runat="server" Text='<%# Bind("UnitWeight") %>' Width="60px" CssClass="val5"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        <FooterStyle BackColor="#f3f3f3" Font-Bold="True" ForeColor="#23A6F0" BorderStyle="Solid" />
                                                ...
                                                <%--Total Weight: <asp:Label ID="lttlWeight" runat="server"></asp:Label> Kg. &nbsp; &nbsp;
                                          Total Quantity(Meter/Pcs):--%>
                                                <asp:Label ID="Label1" runat="server" CssClass="hidden"></asp:Label>
                                                <%-- <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                            SelectCommand="SELECT Id, OrderID, ProductID, ProductName, UnitCost, Quantity, ItemTotal FROM OrderDetails  ORDER BY [Id]"></asp:SqlDataSource>--%>
                                            </asp:Panel>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" Visible="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue" Width="100%"
