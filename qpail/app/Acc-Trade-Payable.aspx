<%@ Page Title="Trade Payables" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Acc-Trade-Payable.aspx.cs" Inherits="app_Acc_Trade_Payable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Trade Payables</h3>
