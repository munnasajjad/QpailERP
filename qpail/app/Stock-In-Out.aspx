<%@ Page Title="In-Out History (Raw)" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-In-Out.aspx.cs" Inherits="app_Stock_In_Out" %>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Stock In-Out History (Raw Items)
                            </div>
                            <div class="tools">
