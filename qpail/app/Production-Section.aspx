<%@ Page Title="Production Lines" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Production-Section.aspx.cs" Inherits="app_Production_Section" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server" >
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">Production Lines
                    </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 ">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Add New Production Line
                            </div>
                        </div>
                                ...
                                <asp:Label ID="lblMsg" runat="server" EnableViewState="false"></asp:Label>
                                    ...
                                    <div id="EditField" runat="server">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" 
                                            SelectCommand="SELECT [Departmentid], DepartmentName FROM [Lines] ORDER BY [DepartmentName]"></asp:SqlDataSource>
                                    </div>
                            ...
                            <div class="form-body">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DepartmentName" HeaderText="Line No./ Name" SortExpression="DepartmentName" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT [Departmentid], [DepartmentName], [Description] FROM [Lines] WHERE Section=@Section  ORDER BY [DepartmentName]">
                                <SelectParameters>
