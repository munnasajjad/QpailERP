...
public partial class app_StockGroup : System.Web.UI.Page
{
    ...
    protected void GridView1_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string isExist
                ...
                = RunQuery.SQLQuery.ReturnString("Select GradeName FROM ItemGrade WHERE CategoryID='" + lblItemCode.Text + "'");
