<%@ Page Title="Raw Stock Adjustment" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-Adj-Raw.aspx.cs" Inherits="app_Stock_Adj_Raw" %>
                                ...
                                <div class="row">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnAdd">
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                <label class="col-sm-12 control-label full-wdth">
                                                    Adjustment Weight (<asp:Literal ID="Literal3" runat="server" Visible="False" />kg)</label>
