<%@ Page Title="Colors" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Employee-Effeciency.aspx.cs" Inherits="app_Employee_Effeciency" %>
                ...
                <div class="col-md-6 ">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Add New Color
                            </div>
                        </div>
                                ...
                                <asp:Label ID="lblMsg" runat="server" EnableViewState="false"></asp:Label>
                                    ...
                                    <div id="EditField" runat="server">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" 
                                            SelectCommand="SELECT [Departmentid], DepartmentName FROM [Colors] ORDER BY [DepartmentName]"></asp:SqlDataSource>
                                    </div>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ...
                                    SelectCommand="SELECT [Departmentid], [DepartmentName], [Description] FROM [Colors] ORDER BY [DepartmentName]"></asp:SqlDataSource>
