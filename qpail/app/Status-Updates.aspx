<%@ Page  Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Status-Updates.aspx.cs" Inherits="Status_Updates" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span12">
                        <h3 class="page-title"> <asp:Literal ID="headName" runat="server"/> Status</h3>
                    </div>
                </div>
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="control-group">
                            <label class="control-label">Status Summery</label>
                            <div class="controls">
                                <asp:TextBox ID="txtName" CssClass="span6 m-wrap form-control" runat="server" ></asp:TextBox>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <asp:FileUpload ID="ThumbUpload" runat="server" UploaderStyle="Modern"  />
                ...
                <asp:Panel ID="SearchPanel" runat="server" Visible="False">
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False"  
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="EntryDate" HeaderText="Status Date" SortExpression="BusNo" DataFormatString="{0:d}" />
                                <asp:BoundField DataField="Subject" HeaderText="Summery" SortExpression="BusNo" />
                                <asp:BoundField DataField="ImgDetail" HeaderText="Status Description" SortExpression="ImgDetail" />
                                <asp:TemplateField HeaderText="Attached File" SortExpression="Img">
                                    <EditItemTemplate>
