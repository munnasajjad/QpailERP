...
public partial class app_FixedAssetPosition : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormFixedAssetPosition.aspx?item=" + ddProduct.SelectedValue + "&dt1=" + dt1;
