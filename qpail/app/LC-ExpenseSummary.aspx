<%@ Page Title="LC Expense Summary" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LC-ExpenseSummary.aspx.cs" Inherits="app_LC_ExpenseSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">LC Expense Summary Report</h3>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" width="60%" style="width: 60%" class="table1">
                                        <tr>
                                            ...
                                            <th class="hidden">Agent Name</th>
                                            <th  class="hidden"></th>

                                            <th class="hidden">Order Date From</th>
                                            <th class="hidden"></th>

                                            <th class="hidden">Order Date To</th>
                                            <th class="hidden"></th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddName" runat="server" AppendDataBoundItems="True" CssClass="form-control select2me"
                                            ...
                                            <td  class="hidden" style="vertical-align: middle;">
                                                <asp:DropDownList ID="ddParty" runat="server" CssClass="select2me" DataSourceID="SqlDataSource2z" DataTextField="Company"
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource2z" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT [PartyID], [Company] FROM [Party]  ORDER BY [Company]">
                                                    
                                                     <SelectParameters>
                                                <%--<asp:ControlParameter Name="PartyType" PropertyName="SelectedValue" />--%>
                                            </SelectParameters>
                                                </asp:SqlDataSource>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                ...
                                                <asp:Button ID="btnReset" CssClass="btn btn-s-md hidden btn-danger" runat="server" Text="Reset" OnClick="btnReset_OnClick" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                            ...
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="ddParty" Name="CustomerID" PropertyName="SelectedValue" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
