<%@ Page Title="Create Login Id" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="New-User.aspx.cs" Inherits="AdminCentral_New_User" %>
                                                ...
                                                <ContentTemplate>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddCounter" runat="server" CssClass="form-control"
                                                                    DataSourceID="SqlDataSource7" DataTextField="DepartmentName" AutoPostBack="True"
                                                                    DataValueField="Departmentid" OnSelectedIndexChanged="ddCounter_OnSelectedIndexChanged">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddEmploye" runat="server" CssClass="form-control"
                                                                    DataSourceID="SqlDataSource40" DataTextField="EName" DataValueField="EmployeeInfoID">
                                                                </asp:DropDownList>
