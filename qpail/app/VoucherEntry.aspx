<%@ Page Title="Voucher Entry" Language="C#" MasterPageFile="~/app/MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="VoucherEntry.aspx.cs" Inherits="Application_VoucherEntry" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title">Vouchers Entry</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                ...
                                                SelectCommand="SELECT Particularsid, [Particularsname] FROM [Particulars] WHERE Particularsid='4' OR Particularsid='7' OR Particularsid='9' ORDER BY [Particularsname]"></asp:SqlDataSource>
                                        </div>
                                    </div>
                                    ...
                                    <asp:Panel ID="pnl3" runat="server" DefaultButton="btnAdd">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Width="70%" Height="100px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="control-group">
                        ...
                        <div class="portlet box red">
                            ...
                            <div class="portlet-body form">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>"
                                    SelectCommand="SELECT VID, [VoucherNo], [VoucherDate], [VoucherDescription], [VoucherAmount] FROM [VoucherMaster] WHERE ([VoucherDate] = @VoucherDate) AND Voucherpost<>'C' AND (VoucherNo Not Like 'Auto%') ORDER BY [VID] DESC"
                                    DeleteCommand="Delete [VoucherDetails] where [SerialNo]=0">
                                    <SelectParameters>
