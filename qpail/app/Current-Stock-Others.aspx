<%@ Page Title="Current Stock: Others" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Current-Stock-Others.aspx.cs" Inherits="app_Current_Stock_Others" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Current Stock (Others)
                    </div>
                    <div class="tools">
