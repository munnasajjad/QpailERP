<%@ Page Title="Wastage Stock Consumption" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="WastageStockConsumption.aspx.cs" Inherits="app_WastageStockConsumption" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Wastage Stock Consumption</h3>
                                        ...
                                        <tr>
                                           <td><b> Date From : </b>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <asp:Button ID="btnSearch" CssClass="btn btn-s-md btn-primary" runat="server" Text="SHOW" OnClick="btnSearch_OnClick" Style="margin-top: 12px;"/>
