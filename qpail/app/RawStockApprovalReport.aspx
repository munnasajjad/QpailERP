<%@ Page Title="Raw Stock Approval Report" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="RawStockApprovalReport.aspx.cs" Inherits="app_RawStockApprovalReport" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Raw Stock Issue
                    </div>
                    <div class="tools">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnSearch">
                                        ...
                                        <div class="col-md-4" runat="server">
                                            <div class="control-group">
                                                ...
                                                <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" Enabled="True" TargetControlID="txtdateFrom">
                                        ...
                                        <div class="col-md-4" runat="server">
                                            <div class="control-group">
                                                ...
                                                <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy" Enabled="True" TargetControlID="txtdateTo">
                                                </asp:CalendarExtender>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="control-group">
                                                <div style="margin-top: 29px">
                                                    ...
                                                    <asp:Button ID="btnExport" runat="server" Width="120px" Text="Export to Excel" OnClick="btnExport_OnClick" Visible="False" />
