<%@ Page Title="Plastic Container Production by Date" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="rpt-Prdn-Plastic-Container.aspx.cs" Inherits="app_rpt_Prdn_Plastic_Container" %>
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] WHERE (GroupID='3') "></asp:SqlDataSource>
                                            </div>
                                        </div>
