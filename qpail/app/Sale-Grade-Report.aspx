<%@ Page Title="Sale by Item Grade" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Sale-Grade-Report.aspx.cs" Inherits="app_Sale_Grade_Report" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box light-grey" style="min-height: 355px;">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Sale by Item Grade
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body col-md-12 table-responsive">
                                ...
                                <asp:GridView ID="GVrpt" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info"
                                    ...
                                    ShowFooter="True" AllowSorting="True" Width="120%" OnPageIndexChanging="GVrpt_OnPageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemGrade" HeaderText="ItemGrade" SortExpression="Nine2Twelve" />
