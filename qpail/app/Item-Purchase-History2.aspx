<%@ Page Title="Item-Purchase-HistoryOld" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Item-Purchase-History2.aspx.cs" Inherits="app_Item_Purchase_History2" %>
            ...
            <div class="row">
                ...
                <div class="form-body col-md-8">
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="GVrpt" class="zebra" aria-describedby="sample_1_info"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PriceWithoutVAT" HeaderText="Cost W/O VAT" SortExpression="PriceWithoutVAT" />
                                <asp:BoundField DataField="PriceWithVAT" HeaderText="Cost+VAT" SortExpression="PriceWithVAT" />
                            </Columns>
