<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-Adj-Finished-Direct.aspx.cs" Inherits="app_Stock_Adj_Finished_Direct" %>
        ...
        <div class="col-md-4 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Set Finished Stock Qty
                    </div>
                    <div class="tools">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnAdd">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">
                                                        Set Qty.(<asp:Literal ID="ltrUnit" runat="server" Visible="False" />pcs)</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group hidden">
                                                    <label class="col-sm-12 control-label full-wdth">
                                                        Set Weight (kg)<asp:Literal ID="Literal3" runat="server" Visible="False" /></label>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Current Weight (kg)" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblUWeight" runat="server" Text='<%# Bind("UnitWeight") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Set Weight (kg)" >
                                            <ItemTemplate>
