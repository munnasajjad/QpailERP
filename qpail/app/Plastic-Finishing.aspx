<%@ Page Title="Production: Plastic Finishing" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Plastic-Finishing.aspx.cs" Inherits="app_Plastic_Finishing" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Plastic Container Finishing</h3>
                            ...
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddSize" runat="server" DataSourceID="SqlDataSource6" DataTextField="BrandName" DataValueField="BrandID"
                                         AutoPostBack="True" OnSelectedIndexChanged="ddPurpose_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label20" runat="server" Text="For Company: "></asp:Label>
                                    <asp:DropDownList ID="ddCompany2" runat="server" DataSourceID="SqlDataSource13"
                                        DataTextField="Company" DataValueField="PartyID"  AutoPostBack="True" OnSelectedIndexChanged="ddCompany2_OnSelectedIndexChanged" AppendDataBoundItems="True">
                                        <asp:ListItem Value="">--- all ---</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddBrand2" runat="server" DataSourceID="SqlDataSource14" DataTextField="BrandName" DataValueField="BrandID" AppendDataBoundItems="True"
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label18" runat="server" Text="Pack Size: "></asp:Label>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddOutSubGroup" CssClass="form-control select2me" runat="server" 
                                        AutoPostBack="True" OnSelectedIndexChanged="ddOutSubGroup_OnSelectedIndexChanged" >
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:DropDownList ID="ddReusableWaste" runat="server" DataSourceID="SqlDataSource15" DataTextField="ItemName" DataValueField="ProductID">
                                        </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label24" runat="server" Text="Reusable Waste (Pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtReusableWasteQty" runat="server" Text="0"></asp:TextBox>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView2_OnRowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ReusableWasteWeight" HeaderText="Reusable Waste (kg)" SortExpression="NetProduction" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource7" runat="server"
                                        ...
                                        (SELECT [CategoryName] FROM [Categories] WHERE [CategoryID] = a.Category) AS  [Category], 
                                         (SELECT [ItemName] FROM [Products] WHERE [ProductID] = a.Item) AS  [Item],
                                          (SELECT [DepartmentName] FROM [Colors] WHERE [Departmentid] = a.Color) AS  [Color], [WeightPerPc], [InputQty], [InputWeight], [Production], [Rejected], [NetProduction], ReusableWasteQty, ReusableWasteWeight FROM [PrdnPlasticFinishDetails] a WHERE ([PrdnID] = '') ORDER BY [Id]"
                                        DeleteCommand="Delete from PrdnPlasticFinishDetails where id=0"
                                        >
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:TextBox ID="txtItemWeight" runat="server" onkeyup="calInvTotal()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender8"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtItemWeight">
                                    </asp:FilteredTextBoxExtender>
                                </div>
                                
                                <div class="control-group">
                                    <asp:Label ID="Label14" runat="server" Text="Total Output Weight (kg) : "></asp:Label>
                                    <asp:TextBox ID="txtFinalWeight" runat="server" ></asp:TextBox>
                                </div>
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" Width="400%" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WeightPerPc" HeaderText="Weight PerPc" SortExpression="WeightPerPc" />
                                            ...
                                            <asp:BoundField DataField="ItemGrade" HeaderText="Item Grade" SortExpression="ItemGrade" />
                                            ...
                                            <asp:BoundField DataField="TimeWaist" HeaderText="Time Waist" SortExpression="TimeWaist" />
                                            <asp:BoundField DataField="WorkingHr" HeaderText="Working Hr" SortExpression="WorkingHr" />
                                            <asp:BoundField DataField="OutputWeight" HeaderText="Output Weight" SortExpression="OutputWeight" />
                                        </Columns>
                                    </asp:GridView>
                                    ...
                                    (Select DepartmentName from Lines where Departmentid=a.LineNumber) AS [LineNumber],
                                       ...
                                       (Select ItemName from Products where ProductID=a.ItemName) AS  [ItemName], 
                                         ...
                                         [WeightPerPc], [FinalOutput],  [Remarks], [Reason], [TimeWaist], [WorkingHr], [OutputWeight] FROM [PrdnPlasticFinish] a ORDER BY [date] desc"
