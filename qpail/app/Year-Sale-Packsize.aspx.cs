...
public partial class app_Year_Sale_Packsize : System.Web.UI.Page
{
    ...
    private DataTable LoadGridData()
    {
        ...
        dr1["January"] = CalcQty("Quantity", sizeId, txtYear.Text + "-01-01", txtYear.Text + "-02-01");
        dr1["February"] = CalcQty("Quantity", sizeId, txtYear.Text + "-02-01", txtYear.Text + "-03-01");
        dr1["March"] = CalcQty("Quantity", sizeId, txtYear.Text + "-03-01", txtYear.Text + "-04-01");
        dr1["April"] = CalcQty("Quantity", sizeId, txtYear.Text + "-04-01", txtYear.Text + "-05-01");
        dr1["May"] = CalcQty("Quantity", sizeId, txtYear.Text + "-05-01", txtYear.Text + "-06-01");
        dr1["June"] = CalcQty("Quantity", sizeId, txtYear.Text + "-06-01", txtYear.Text + "-07-01");
        dr1["July"] = CalcQty("Quantity", sizeId, txtYear.Text + "-07-01", txtYear.Text + "-08-01");
        dr1["August"] = CalcQty("Quantity", sizeId, txtYear.Text + "-08-01", txtYear.Text + "-09-01");
        dr1["September"] = CalcQty("Quantity", sizeId, txtYear.Text + "-09-01", txtYear.Text + "-10-01");
        dr1["October"] = CalcQty("Quantity", sizeId, txtYear.Text + "-10-01", txtYear.Text + "-11-01");
        dr1["November"] = CalcQty("Quantity", sizeId, txtYear.Text + "-11-01", txtYear.Text + "-12-01");

        int nextYear = Convert.ToInt32(txtYear.Text) + 1;
        dr1["December"] = CalcQty("Quantity", sizeId, txtYear.Text + "-12-01", nextYear + "-01-01");
        dr1["Total"] = CalcQty("Quantity", sizeId, txtYear.Text + "-01-01", nextYear + "-01-01");
        ...
        dr1["January"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-01-01", txtYear.Text + "-02-01");
        dr1["February"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-02-01", txtYear.Text + "-03-01");
        dr1["March"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-03-01", txtYear.Text + "-04-01");
        dr1["April"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-04-01", txtYear.Text + "-05-01");
        dr1["May"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-05-01", txtYear.Text + "-06-01");
        dr1["June"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-06-01", txtYear.Text + "-07-01");
        dr1["July"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-07-01", txtYear.Text + "-08-01");
        dr1["August"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-08-01", txtYear.Text + "-09-01");
        dr1["September"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-09-01", txtYear.Text + "-10-01");
        dr1["October"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-10-01", txtYear.Text + "-11-01");
        dr1["November"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-11-01", txtYear.Text + "-12-01");

        dr1["December"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-12-01", nextYear + "-01-01");
        dr1["Total"] = CalcQty("ItemTotal", sizeId, txtYear.Text + "-01-01", nextYear + "-01-01");
        ...
        dr1 = dt1.NewRow();
        dr1["RowName"] = "VAT (Tk.)";
        dr1["January"] = CalcQty("VAT", sizeId, txtYear.Text + "-01-01", txtYear.Text + "-02-01");
        dr1["February"] = CalcQty("VAT", sizeId, txtYear.Text + "-02-01", txtYear.Text + "-03-01");
        dr1["March"] = CalcQty("VAT", sizeId, txtYear.Text + "-03-01", txtYear.Text + "-04-01");
        dr1["April"] = CalcQty("VAT", sizeId, txtYear.Text + "-04-01", txtYear.Text + "-05-01");
        dr1["May"] = CalcQty("VAT", sizeId, txtYear.Text + "-05-01", txtYear.Text + "-06-01");
        dr1["June"] = CalcQty("VAT", sizeId, txtYear.Text + "-06-01", txtYear.Text + "-07-01");
        dr1["July"] = CalcQty("VAT", sizeId, txtYear.Text + "-07-01", txtYear.Text + "-08-01");
        dr1["August"] = CalcQty("VAT", sizeId, txtYear.Text + "-08-01", txtYear.Text + "-09-01");
        dr1["September"] = CalcQty("VAT", sizeId, txtYear.Text + "-09-01", txtYear.Text + "-10-01");
        dr1["October"] = CalcQty("VAT", sizeId, txtYear.Text + "-10-01", txtYear.Text + "-11-01");
        dr1["November"] = CalcQty("VAT", sizeId, txtYear.Text + "-11-01", txtYear.Text + "-12-01");

        dr1["December"] = CalcQty("VAT", sizeId, txtYear.Text + "-12-01", nextYear + "-01-01");
        dr1["Total"] = CalcQty("VAT", sizeId, txtYear.Text + "-01-01", nextYear + "-01-01");
        ...
        dr1["January"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-01-01", txtYear.Text + "-02-01");
        dr1["February"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-02-01", txtYear.Text + "-03-01");
        dr1["March"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-03-01", txtYear.Text + "-04-01");
        dr1["April"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-04-01", txtYear.Text + "-05-01");
        dr1["May"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-05-01", txtYear.Text + "-06-01");
        dr1["June"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-06-01", txtYear.Text + "-07-01");
        dr1["July"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-07-01", txtYear.Text + "-08-01");
        dr1["August"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-08-01", txtYear.Text + "-09-01");
        dr1["September"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-09-01", txtYear.Text + "-10-01");
        dr1["October"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-10-01", txtYear.Text + "-11-01");
        dr1["November"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-11-01", txtYear.Text + "-12-01");

        dr1["December"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-12-01", nextYear + "-01-01");
        dr1["Total"] = CalcQty("NetAmount", sizeId, txtYear.Text + "-01-01", nextYear + "-01-01");
    ...
    private int CalcQty(string colName, string sizeId, string dtFrom, string dtTo)
    {
        ...
        {
            qty = Convert.ToInt32(Convert.ToDecimal(SQLQuery.ReturnString("Select ISNULL(SUM(" + colName + "),0)  FROM [SaleDetails] WHERE  ProductID IN (Select ProductID from Products where CategoryID IN (SELECT CategoryID from Categories where GradeID='" + ddGrade.SelectedValue + "')) AND  ([SizeId] = '" + sizeId + "') AND InvNo IN (SELECT InvNo FROM Sales WHERE (CustomerID = '" + ddCustomer.SelectedValue + "') AND (DeliveryDate >= '" + dtFrom + "') AND (DeliveryDate <= '" + dtTo + "'))")));
        }
        return qty;
    }
    ...
    {
        exportExcel(LoadGridData(), "Yearly-Sales-by-Pack-size-Report");
    }
