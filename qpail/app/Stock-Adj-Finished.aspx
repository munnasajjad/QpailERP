<%@ Page Title="Finished Stock Adjustment" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-Adj-Finished.aspx.cs" Inherits="app_Stock_Adj_Finished" %>
        ...
        <div class="col-md-4 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Finished Stock Adjustment
                    </div>
                    <div class="tools">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnAdd">
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddSubGroup" runat="server" DataSourceID="SqlDataSource9" DataTextField="CategoryName" DataValueField="CategoryID"
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] where (GroupID = 2) ">
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">
                                                        Current Stock Weight (Kg)<asp:Literal ID="Literal5" runat="server" Visible="False" /></label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">
                                                        Adjustment Weight (Kg)<asp:Literal ID="Literal3" runat="server" Visible="False" /></label>
                                                    <asp:TextBox ID="txtUnitWeight" runat="server" Visible="False"/> <%--Weight per Piece --%>
                                                    <asp:TextBox ID="txtWeight" runat="server" /> <%-- Adjustment Weight --%>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Unit Weight (gm)" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblUWeight" runat="server" Text='<%# Bind("UnitWeight") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Adjust Weight (kg)" >
                                            <ItemTemplate>
                                                <asp:Label ID="lbliWeight" runat="server" Text='<%# Bind("TotalWeight") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SelectedRowStyle-BackColor="LightBlue"
                                    OnRowDataBound="ItemGrid_RowDataBound" OnRowDeleting="ItemGrid_RowDeleting" OnSelectedIndexChanged="ItemGrid_SelectedIndexChanged" DataSourceID="SqlDataSource12">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT TOP(100) [EntryDate], [EntryType], [InvoiceID], [RefNo], [ProductName],
