...
public partial class app_Docs_PO_Upload : System.Web.UI.Page
{
    ...
    protected void AsyncFileUpload1_UploadComplete(object sender, AjaxControlToolkit.AsyncFileUploadEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("INSERT INTO ImportentDocuments (BusNo, ImgDetail, Img, DocType, LinkID, EntryBy)" +
                                    "VALUES (@PONo, '', @Img, 'PO', '', @EntryBy)", new SqlConnection(ConfigurationManager.ConnectionStrings["LocalSqlServer"].ConnectionString));
        ...
        cmd.Parameters.AddWithValue("@Img", "Docs/PO/" + fileName);
