<%@ Page Title="LC Expense Details" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LC-ExpenseDetails.aspx.cs" Inherits="app_LC_ExpenseDetails" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <h3 class="page-title">
        <asp:Literal ID="ltrFrmName" runat="server" Text="LC Expense Details" />
    </h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet box red">
                ...
                <div id="qPanel">
                    <div id="datePanel">
                        <asp:Label ID="Label2" runat="server" Text="LC A/C Head :"></asp:Label>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                            ...
                            SelectCommand="SELECT HeadSetup.AccountsHeadID, HeadSetup.AccountsHeadName FROM HeadSetup INNER JOIN
                         LC ON HeadSetup.AccountsHeadID = LC.AccountsHeadID ORDER BY HeadSetup.AccountsHeadID"></asp:SqlDataSource>
