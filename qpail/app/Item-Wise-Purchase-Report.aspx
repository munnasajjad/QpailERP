<%@ Page Title="Item Wise Purchase Report" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Item-Wise-Purchase-Report.aspx.cs" Inherits="app_Item_Wise_Purchase_Report" %>
                ...
                <div class="col-md-4">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>Item Wise Purchase Report
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddGroup" runat="server" DataSourceID="SqlDataSource3" AutoPostBack="true" Width="69%" CssClass="select2me"
                                DataTextField="GroupName" DataValueField="GroupSrNo" OnSelectedIndexChanged="ddGroup_SelectedIndexChanged" AppendDataBoundItems="False">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddSubGrp" runat="server" AutoPostBack="true" Width="69%" CssClass="select2me" OnSelectedIndexChanged="ddSubGrp_SelectedIndexChanged" AppendDataBoundItems="False">
                            </asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddGrade" runat="server" AutoPostBack="true" Width="69%" CssClass="select2me" OnSelectedIndexChanged="ddGrade_SelectedIndexChanged" AppendDataBoundItems="False">
                            </asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddCategory" runat="server" AutoPostBack="true" Width="69%" CssClass="select2me" OnSelectedIndexChanged="ddCategory_SelectedIndexChanged" AppendDataBoundItems="False">
                            </asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddItemName" runat="server" AutoPostBack="true" Width="69%" CssClass="select2me" OnSelectedIndexChanged="ddItemName_SelectedIndexChanged" AppendDataBoundItems="False">
                            </asp:DropDownList>
