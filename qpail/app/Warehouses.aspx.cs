...
public partial class Operator_Warehouses : System.Web.UI.Page
{
    ...
    private void ExecuteInsert()
    {
        try
        {
            ...
            SqlCommand cmd2 = new SqlCommand("INSERT INTO Warehouses (Zone, StoreName, Address, Owner, Description, ProjectID, EntryBy) VALUES (@Zone, @GroupName, @Address, @Owner, @Description, @ProjectID, @EntryBy)", new SqlConnection(ConfigurationManager.ConnectionStrings["LocalSqlServer"].ConnectionString));
