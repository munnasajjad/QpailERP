<%@ Page Title="IML Print" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="IML-Print.aspx.cs" Inherits="app_IML_Print" %>
                    ...
                    <div class="portlet box red">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <a name="OpDetails"></a>
                                <legend style="margin-bottom: 6px;">IML Impresion</legend>
                                <asp:Label ID="lblMsg2" runat="server" EnableViewState="false"></asp:Label>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [MachineNo], [mid] FROM [Machines] where Section=8 ORDER BY [MachineNo]"></asp:SqlDataSource>
                                </div>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label10" runat="server" Text="IML Category : "></asp:Label>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label23" runat="server" Text="IML Consumption (pcs) : "></asp:Label>
                         ...
                         Reason, 
                                  (Select DepartmentName from Shifts where Departmentid=a.Shift) AS  Shift, WastePcs, WasteKg, EntryBy
                                     FROM [PrdIMLPrintDetails] a 
                                    where PrdnID='' AND Section='Offset Printing' ORDER BY [id]"
                                        DeleteCommand="Delete FROM [PrdIMLPrintDetails]  where PrdnID='0'  "></asp:SqlDataSource>
                                ...
                                <div class="table-responsive">
                                    ...
                                    (Select DepartmentName from Lines where Departmentid=a.LineNumber) AS [LineNumber],
                                       ...
                                       (Select ItemName from Products where ProductID=a.ItemName) AS  [ItemName], 
                                         ...
                                         [FinalOutput], [FinalOutputKg], [Remarks] FROM [PrdIMLPrint] a  ORDER BY [date] desc"
