...
public partial class app_Acc_Trade_Payable : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormTradePayable.aspx?dateFrom=" + dt1;
