<%@ Page Title="LC Voucher Approval" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LC-VoucherApproval.aspx.cs" Inherits="app_LC_VoucherApproval" %>
                            ...
                            <div>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" width="100%" style="width:100%" class="table1">
                                        ...
                                        <tr>
                                            <td width="40%" >LC NO :</td>
                                            <td>
                                                <asp:DropDownList ID="ddCustomer" runat="server" CssClass="form-control select2me" DataSourceID="SqlDataSource3" 
                                                    DataTextField="LCNo" DataValueField="sl" AppendDataBoundItems="true">
                                                    <asp:ListItem>---ALL---</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT SL, [LCNo] FROM [LC] WHERE ([IsActive] = 'A') ORDER BY [LCNo]"></asp:SqlDataSource>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT [WID], [StoreName] FROM [Warehouses] ORDER BY [StoreName]">
                                        ...
                                        <tr style="background: none">
                                            ...
                                            <td style="text-align: right;">
                                                ...
                                                <asp:Button ID="btnReset" CssClass="btn btn-s-md btn-white hidden" runat="server" Text="Reset" OnClick="btnReset_OnClick" />
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                            ...
                            <div>
                                ...
                                <asp:Literal ID="ltrtotal" runat="server"></asp:Literal>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="90%" CssClass="table-hover"  
                                            BorderStyle="Solid" BorderWidth="1px" CellPadding="7" ForeColor="Black" GridLines="Vertical"
                                            DataKeyNames="VID" AllowPaging="True" PageSize="25" OnPageIndexChanging="GridView1_OnPageIndexChanging" >
                                            ...
                                            <Columns>
                                                ...
                                                <%--<asp:BoundField DataField="LCNo" HeaderText="LC No" SortExpression="LCNo" DataFormatString="{0:d}" />--%>
                                                <asp:BoundField DataField="VoucherNo" HeaderText="VoucherNo" SortExpression="VoucherNo" />
                                                <asp:BoundField DataField="LCNo" HeaderText="LCNo" SortExpression="LCNo" />
                                                <asp:BoundField DataField="VoucherAmount" HeaderText="VoucherAmount" SortExpression="VoucherAmount" />
