<%@ Page Title="Machine Stock Transfer" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="MachineToMachineTransfer.aspx.cs" Inherits="app_MachineToMachineTransfer" %>
        ...
        <div class="col-md-4 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Machine to Machine Stock Transfer
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="control-group">
                                <label class="control-label full-wdth">Transfer from Machine : </label>
                                <asp:DropDownList ID="ddMachineFrom" runat="server" DataSourceID="SqlDataSource6"
                                    DataTextField="MachineNo" DataValueField="mid" CssClass="form-control"
                            ...
                            <div class="control-group">
                                <label class="control-label full-wdth">Transfer to Machine : </label>
                                <asp:DropDownList ID="ddMachineTo" runat="server" DataSourceID="SqlDataSource6"
                                    DataTextField="MachineNo" DataValueField="mid" CssClass="form-control"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddGodown_SelectedIndexChanged">
                                </asp:DropDownList>
...
(SELECT [MachineNo] FROM [Machines] WHERE  mid=MachineStock.MachineID) AS Godown, 
                                    [InQuantity], [OutQuantity], [InWeight], [OutWeight], price, Remark FROM [MachineStock] WHERE ([ProductID] = @ProductID) AND EntryType='Raw Material Input'
