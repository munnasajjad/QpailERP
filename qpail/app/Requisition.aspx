<%@ Page Title="Requisition Entry" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Requisition.aspx.cs" Inherits="app_Requisition" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">
                        <asp:Literal ID="ltrHead" runat="server" Text="Material Requisition Entry"></asp:Literal></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 ">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Requisition Details
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <span style="color: Maroon;">
                                    ...
                                    <asp:Label ID="lblLastDate" runat="server" Text="" Visible="false" />
                                    <asp:Label ID="lblLastQty" runat="server" Text="" Visible="false" />
                                    <asp:Label ID="lblLastPrice" runat="server" Text="" Visible="false" />
                                </span>

                                <div id="divinvoice" runat="server" class="control-group hidden">
                                    <asp:Label ID="Label3" runat="server" Text="Invoice to edit :  "></asp:Label>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <span style="width: 70%; color: green; float: right; font-weight: bold">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Available (<asp:Literal ID="ltrUnitTypeLast" runat="server" />) : </label>
                                    <asp:TextBox ID="txtAvailableQty" runat="server" CssClass="form-control" ReadOnly="True" onkeyup="calTtl()"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered" Width="200%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Specification">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSpec" runat="server" Text='<%# Bind("SizeRef") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="10%" />
                                            </asp:TemplateField>
                                ...
                                <div class="full_block right bold hidden">
                                    <br />
                                    Total item amount:
                                ...
                                <div class="full_block right bold">
                                    <br />
                                Total other expense amount: <asp:Label ID="lblOthersTotal" runat="server" ></asp:Label>
                                 <br /> <br />
                                </div>--->
                                ...
                                <div class="form-actions">
                                    <asp:Button ID="btnSave" runat="server" Text="Save Requisition" CssClass="btn blue" OnClick="btnSave_Click" />
                            ...
                            <div class="form-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT [Itemgroup], [SubGroup], [Grade], [Category], [ItemName], [pcs], [Qty], [Price], [Total], [Manufacturer], [CountryOfOrigin], [PackSize], [Warrenty], [SerialNo], [UnitType], [SizeRef], [StockType], [StockLocation], [PerviousDeliveredQty], [QtyBalance], [PriceWithVAT], [PriceWithoutVAT], [ReturnQty] FROM [PurchaseDetails] WHERE ([InvNo] = @InvNo) ORDER BY [Id]">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="lblInvoice" Name="Id" PropertyName="Text" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>

                                    <asp:GridView ID="GridView1" runat="server" Width="100%" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                                        <Columns>
                                            <asp:BoundField DataField="Date" HeaderText="Req. Date" SortExpression="Date" DataFormatString="{0:d}" />
                                            <asp:TemplateField HeaderText="ReqNo/Print" SortExpression="ReqNo">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl='<%#Eval("ReqId") %>'>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("ReqNo") %>'></asp:Label>
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="ItemTotal" HeaderText="Item Total" SortExpression="PurchaseTotal" />
                                            <asp:BoundField DataField="PurchaseDiscount" HeaderText="Discount" SortExpression="PurchaseTotal" />
                                            <asp:BoundField DataField="VatService" HeaderText="Vat/Service" SortExpression="PurchaseTotal" />
                                            <asp:BoundField DataField="OtherExp" HeaderText="Others" SortExpression="PurchaseTotal" />
                                            <asp:BoundField DataField="PurchaseTotal" HeaderText="P.Total" SortExpression="PurchaseTotal" />--%>
                                        </Columns>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT TOP(20) Id, Date, ReqNo, (Select DefaultLink from Settings_Project where sid='1') +'XerpReports/Requisition.aspx?ReqNo='+ReqNo As ReqId, FromDept, Remarks, Status, UpdatedBy, EntryDate, EntryBy FROM [Requisition] ORDER BY Id DESC">
                                        <SelectParameters>
