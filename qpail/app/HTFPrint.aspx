<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="HTFPrint.aspx.cs" Inherits="app_HTFPrint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function calInvTotal() {
            ...
            var ttlProjected = (stdPrdn * 1) * ((txtHour * 1) + (txtMin / 60));
            $('#<%=txtStdPrdn.ClientID%>').val(parseInt(ttlProjected).toString());
        ...
        function calContainerRej() {
            var prRejCont = document.getElementById("<%= txtPrRejContainer.ClientID %>").value;
            var qcRejCont = document.getElementById("<%= txtQCRejContainer.ClientID %>").value;
            var ttl = parseFloat(prRejCont) + parseFloat(qcRejCont);
            $('#<%=txtRejected.ClientID%>').val(ttl.toString());

            var finalInput = document.getElementById("<%= txtFinalInput.ClientID %>").value;
            var rejContainer = document.getElementById("<%= txtRejected.ClientID %>").value;
            var ttl1 = parseFloat(finalInput) - parseFloat(rejContainer);
            $('#<%=txtproduced.ClientID%>').val(ttl1.toString());

            var sERejFoil = document.getElementById("<%= txtSERejectFoil.ClientID %>").value;
            var qcRejFoil = document.getElementById("<%= txtQCRejectFoil.ClientID %>").value;
            var netProduction = document.getElementById("<%= txtproduced.ClientID %>").value;
            var ttl2 = parseFloat(sERejFoil) + parseFloat(qcRejFoil) + parseFloat(rejContainer) + parseFloat(netProduction);
            $('#<%=txtInkConsum.ClientID%>').val(ttl2.toString());
        }
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">HTF Print</h3>
                    ...
                    <div class="portlet box red">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label27" runat="server" Text="Pack Size: "></asp:Label>
                                    <asp:DropDownList ID="ProductionInputPackSizeDropdown" runat="server" DataSourceID="SqlDataSource6" DataTextField="BrandName" DataValueField="BrandID"
                                        AutoPostBack="True" OnSelectedIndexChanged="ProductionInputPackSizeDropdown_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label34" runat="server" Text="Semifinished Pack Size: "></asp:Label>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddGodown" runat="server" DataSourceID="SqlDataSource20"
                                        DataTextField="StoreName" DataValueField="WID" CssClass="form-control"
                                        AutoPostBack="True" OnSelectedIndexChanged="ddGodown_OnSelectedIndexChanged" Enabled="False">
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource15" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT [DepartmentName], [Departmentid] FROM [Colors] ORDER BY [DepartmentName]"></asp:SqlDataSource>
                                ...
                                <a name="OpDetails"></a>
                                <legend style="margin-bottom: 6px;">HTF Impresion</legend>
                                <asp:Label ID="lblMsg2" runat="server" EnableViewState="false"></asp:Label>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT CONCAT(MachineNo,'  ',Description) AS MachineNo, mid FROM Machines WHERE Section=38 ORDER BY MachineNo"></asp:SqlDataSource>
                                </div>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label10" runat="server" Text="HTF Category : "></asp:Label>
                                ...
                                <div class="control-group hidden">
                                    <asp:Label ID="Label14e" runat="server" Text="Hourly Production (Pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtStdHour" runat="server" Text="0"></asp:TextBox>
                                </div>

                                <div class="control-group">
                                    <asp:Label ID="Label28" runat="server" Text="Starting & End Rej Foil Qty: "></asp:Label>
                                    <asp:TextBox ID="txtSERejectFoil" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender17"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtSERejectFoil">
                                    </asp:FilteredTextBoxExtender>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="Label29" runat="server" Text="Rej with Container Qty: "></asp:Label>
                                    <asp:TextBox ID="txtPrRejContainer" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender16"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtPrRejContainer">
                                    </asp:FilteredTextBoxExtender>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="Label30" runat="server" Text="QC Rej with Container Qty: "></asp:Label>
                                    <asp:TextBox ID="txtQCRejContainer" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender15"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtQCRejContainer">
                                    </asp:FilteredTextBoxExtender>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="Label31" runat="server" Text="QC Rej Foil Qty: "></asp:Label>
                                    <asp:TextBox ID="txtQCRejectFoil" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtQCRejectFoil">
                                    </asp:FilteredTextBoxExtender>
                                </div>
                                <div class="control-group hidden">
                                    <asp:Label ID="Label14" runat="server" Text="Projected Production : "></asp:Label>
                                    <asp:TextBox ID="txtStdPrdn" runat="server" onkeyup="calInpTotal()"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender5"
                                        runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtStdPrdn">
                                    </asp:FilteredTextBoxExtender>
                                </div>

                                <div class="control-group">
                                    <asp:Label ID="Label15" runat="server" Text="Container Rejected (Pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtRejected" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:TextBox ID="txtproduced" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                ...
                                <div class="control-group ">
                                    <asp:Label ID="Label23" runat="server" Text="HTF Consumption (pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtInkConsum" runat="server" onkeyup="calContainerRej()"></asp:TextBox>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView2_OnRowDataBound"
                                        DataSourceID="SqlDataSource7" Width="150%" OnSelectedIndexChanged="GridView2_OnSelectedIndexChanged" OnRowDeleting="GridView2_OnRowDeleting" DataKeyNames="Id">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SERejectedFoil" HeaderText="Rej. Foil" SortExpression="SERejectedFoil" />
                                            <asp:BoundField DataField="PrdnRejectedCont" HeaderText="Rej. Cont" SortExpression="PrdnRejectedCont" />
                                            <asp:BoundField DataField="QCRejectedCont" HeaderText="QC Rej. Cont" SortExpression="QCRejectedCont" />
                                            <asp:BoundField DataField="QCRejectedFoil" HeaderText="QC Rej. Foil" SortExpression="QCRejectedFoil" />
                                  ...
                                  (Select DepartmentName from Shifts where Departmentid=a.Shift) AS  Shift, WastePcs, WasteKg, EntryBy,SERejectedFoil,PrdnRejectedCont,QCRejectedCont,QCRejectedFoil
                                     FROM [PrdHTFPrintDetails] a 
                                    where PrdnID='' AND Section='Offset Printing' ORDER BY [id]"
                                        DeleteCommand="Delete FROM [PrdHTFPrintDetails]  where PrdnID='0'  "></asp:SqlDataSource>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label20" runat="server" Text="HTF Printing Output (pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtFinalOutput" runat="server" onkeyup="calInvTotal()"></asp:TextBox>
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label32" runat="server" Text="Reject Handle Qty (pcs) : "></asp:Label>
                                    <asp:TextBox ID="txtHandleReject" runat="server" onkeyup="calFinishGoods()"></asp:TextBox>
                                </div>
                                <div class="control-group">
                                    <asp:Label ID="Label33" runat="server" Text="Final Finish Goods Qty (pcs) : "></asp:Label>
                            ...
                            <div class="form-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" Width="250%" AllowSorting="True"
                                        ...
                                        GridLines="Vertical" DataSourceID="SqlDataSource3" AllowPaging="True" PageSize="15" OnRowDeleting="GridView1_OnRowDeleting">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RejHandleQty" HeaderText="Handle Rejected" SortExpression="RejHandleQty"/>
                                            <asp:BoundField DataField="FinishGoodsQty" HeaderText="Finish Goods Qty" SortExpression="FinishGoodsQty"/>
                                    ...
                                    (Select DepartmentName from Lines where Departmentid=a.LineNumber) AS [LineNumber],
                                       ...
                                       (Select ItemName from Products where ProductID=a.ItemName) AS  [ItemName], 
                                         ...
                                         [FinalOutput], RejHandleQty, FinishGoodsQty,[Remarks] FROM [PrdHTFPrint] a  ORDER BY [date] desc"
