...
public partial class app_Current_Stock_Machineries : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormCurrentStockMachineries.aspx?godown=" + ddGodown.SelectedValue + "&location=" + ddLocation.SelectedValue + "&group=" + ddGroup.SelectedValue + "&subgro=" + ddSubGroup.SelectedValue + "&dt1=" + dt1;
    ...
    private DataTable BindItemGrid()
    {
        ...
        try
        {
            ...
            string query = " FROM Stock where ItemGroup='" + ddGroup.SelectedValue + "' " + godown + location + subGroup + date;
    ...
    {
        exportExcel(BindItemGrid(), "Current-Stock-Machineries-and-Electrical-Report");
    }
