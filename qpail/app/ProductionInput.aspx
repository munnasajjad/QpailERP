<%@ Page Title="Raw Material Input" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="ProductionInput.aspx.cs" Inherits="app_ProductionInput" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function calInvTotal() {
            ...
            var ttlw = ttl * (txtWeightPc * 1) / 1000;
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Raw Material Input</h3>
                ...
                <div class="col-md-6">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Raw Material Entry
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    <asp:Label ID="Label4" runat="server" Text="Mixing Date :"></asp:Label>
                                ...
                                <div class="control-group hidden">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [MouldName], [Id] FROM [MouldInfo] ORDER BY Id DESC ">
                                    </asp:SqlDataSource>
                                </div>
                               ...
                               <%-- <div class="control-group">
                                ...
                                <div class="control-group hidden">
                                    <asp:Label ID="Label21" runat="server" Visible="False" Text="Brand Name: "></asp:Label>
                                    <asp:DropDownList ID="ddBrand" runat="server" Visible="False" DataSourceID="SqlDataSource5" DataTextField="BrandName" DataValueField="BrandID" AppendDataBoundItems="True">
                                        <asp:ListItem Value="">--- all ---</asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <div class="control-group hidden">
                                    <asp:Label ID="Label2" runat="server" Visible="False" Text="Pack Size: "></asp:Label>
                                    <asp:DropDownList ID="ddSize" runat="server" Visible="False" DataSourceID="SqlDataSource6" DataTextField="BrandName" DataValueField="BrandID"
                                ...
                                <div class="control-group hidden">
                                    <asp:Label ID="Label12" runat="server" Visible="False" Text="Operation Name: "></asp:Label>
                                    <asp:DropDownList ID="ddOperation" runat="server" Visible="False" DataSourceID="SqlDataSource9x"
                                ...
                                <%-- INPUT RATIO --%>
                                    ...
                                    <legend style="margin-bottom: 6px;">Raw Material Details</legend>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource7" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT Id, PrdnID, Department, Purpose, SizeId, BrandID, ItemGroup, SubGroup, Grade, Category, ProductID, ProductName, TotalWeight, ConsumedWeight, EntryBy, EntryDate
                                    FROM ProductionInput WHERE (PrdnID =(SELECT TOP (1) ProductionID FROM ProductionOutput WHERE (MachineNo = '4') ORDER BY pid DESC))"
                                    DeleteCommand="Delete FROM [ProductionInput] where PrdnID='0'  ">
                                    <SelectParameters>
                            ...
                            <a name="ItemDetails"></a>
                                        ...
                                        <!-- #region Visible False -->
                          <%--  <legend style="margin-bottom: 6px;" Visible="False">Production Output</legend>--%>
                            <%--<asp:Label ID="lblMsg2" runat="server" EnableViewState="false"></asp:Label>--%>
                                ...
                                <div class="control-group hidden">
                                    <label class="control-label" >Item Grade :  </label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddOutGrade" Visible="False" runat="server" AutoPostBack="true"
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    WHERE  ProductionID <> ' ' AND EntryType = 'ProductionInput' ORDER BY pid DESC"
