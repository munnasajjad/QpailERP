<%@ Page Title="Collection Edit" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="CollectionEdit.aspx.cs" Inherits="app_CollectionEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function calTotal() {
            var checkBox = document.getElementById("ctl00_BodyContent_cbAdvanceCollection");
        ...
        function jScript() {
            ...
            <%--$('#<%=txtReceived.ClientID%>').attr('readonly', true);--%>
        ...
        <div class="col-md-6">
            <div class="portlet box red">
                ...
                <div class="portlet-body form">
                    ...
                    <asp:Label ID="lblInvoNo" runat="server" Visible="False"></asp:Label>
                    <div class="form-body">

                                <div class="control-group">
                                    <label class="control-label">Advance Collection : </label>
                                    <div class="controls">
                                        <asp:CheckBox ID="cbAdvanceCollection" runat="server" value="Advance" AutoPostBack="true" Enabled="false" />
                                    </div>
                                </div>
                         ...
                         <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddCollectionInvo" runat="server" DataSourceID="SqlDataSource4" CssClass="form-control select2me"
                                DataTextField="CollectionNo" DataValueField="CollectionNo" AutoPostBack="true" OnSelectedIndexChanged="ddCollectionInvo_OnSelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                SelectCommand="SELECT CollectionID, CollectionNo FROM [Collection] ORDER BY CollectionNo">
                                <%--<SelectParameters>
                        ...
                        <div class="control-group">
                            ...
                            <asp:TextBox ID="txtColDate" runat="server" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group" >
                            ...
                            <asp:DropDownList ID="ddCustomer" runat="server" DataSourceID="SqlDataSource1" CssClass="form-control select2me"
                                DataTextField="Company" DataValueField="PartyID" AutoPostBack="true" Enabled="False">
                            </asp:DropDownList>
                        ...
                        <div class="control-group" runat="server" id="InvoiceNoTable">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                SelectCommand="SELECT [InvNo], InvNo+' Dated: '+ (CONVERT(varchar,InvDate,103) +'') AS InvDetail FROM [Sales] WHERE SalesMode<>'LC' AND InvNo In (Select InvNo from CollectionInvoices where CollectionNo=@CollectionNo) order by SaleID">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddCollectionInvo" Name="CollectionNo" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <span style="width: 100%; color: green; text-align: right">
                            ...
                            <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="InvoiceNo" GridLines="Vertical">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bad Debt Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBadDebt" runat="server" Width="100px" Text='<%#Bind("BadDebt") %>' CssClass="val4"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Collected Amount">
                                        <ItemTemplate>
                                            <asp:TextBox ID="lblDueAmount" runat="server" Width="100px" Text='<%# Bind("CollAmount") %>' CssClass="val3"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div runat="server" id="advanceCollection">
                        <div class="control-group">
                       ...
                       <asp:Panel ID="otherPnlId" runat="server" Visible="false">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddAccHead" runat="server" DataSourceID="SqlDataSource7" DataTextField="AccountsHeadName" DataValueField="AccountsHeadID" CssClass="form-control select2me" AutoPostBack="True">
                                </asp:DropDownList>
                        ...
                        <div runat="server" id="advanceBankCollection">
                           <asp:Panel ID="chqpanel" runat="server">
                            <div class="form-group">
                            ...
                            <div runat="server" id="hideForCheque">
                                <div class="control-group">
                                    <asp:Label ID="Label10" runat="server" Text="Invoice Due Amount : "></asp:Label>
                                    <asp:TextBox ID="txtInvTotal" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <div class="control-group">
                            ...
                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1"
                                runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtReceived">
                            </asp:FilteredTextBoxExtender>
                        </div>
                        ...
                        <div class="form-actions">
                            <asp:Button ID="btnSave" runat="server" Text="Update Collection" OnClick="btnSave_Click" />
                        </div>
