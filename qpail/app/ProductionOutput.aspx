<%@ Page Title="Produced Item" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="ProductionOutput.aspx.cs" Inherits="app_ProductionOutput" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function calInvTotal() {
            ...
            $('#<%=txtTotalWestage.ClientID%>').val(parseFloat(ttlw).toFixed(2).toString());
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Produced Item Entry</h3>
                ...
                <div class="col-md-6">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Produced Item Entry
                            </div>
                        </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource22" runat="server"
                                        ...
                                        SelectCommand="SELECT [SID], [SName] FROM [Sections] WHERE sid=7 or sid=8 or sid=14 or sid=15 or (sid>=16 and sid<=18) OR sid = 42  ORDER BY [SName]">
                                        <SelectParameters>
                                ...
                                <div class="control-group">
                                    ...
                                    <%--SELECT DISTINCT S.GodownID AS WID, W.StoreName FROM Sections AS S INNER JOIN Warehouses AS W ON S.GodownID = W.WID--%>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddSize" runat="server" DataSourceID="SqlDataSource6" DataTextField="Size" DataValueField="Id"
                                ...
                                <div runat="server" class="control-group" id="imlGrade">
                                    <label>IML Grade : </label>
                                    <asp:DropDownList ID="ddIMLGrade" runat="server" DataSourceID="SqlDataSource18" DataTextField="GradeName" DataValueField="GradeID"
                                ...
                                <div runat="server" class="control-group" id="imlCategory">
                                    <asp:Label ID="Label26" runat="server" Text="IML Category : "></asp:Label>
                                    <asp:DropDownList ID="ddIMLCategory" runat="server" DataSourceID="SqlDataSource17"
                                        DataTextField="CategoryName" DataValueField="CategoryID" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="ddIMLCategory_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource17" runat="server"
                                        ...
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ddIMLGrade" Name="GradeID" PropertyName="SelectedValue" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </div>

                                <div runat="server" class="form-group" id="imlItemName">
                                    ...
                                    <span style="width: 70%; color: green; float: right">
                                        <asp:Literal ID="literalIMLStock" runat="server">Available  Stock: Qnty(Kg).... </asp:Literal>
                                    </span>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:DropDownList ID="ddOutCategory" runat="server" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddOutCategory_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div runat="server" class="control-group" id="imlUsePcs">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource12x" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                            SelectCommand="SELECT dbo.Products.ProductID, CONCAT (dbo.Products.ItemName,'>>',dbo.Categories.CategoryName) AS ItemName FROM dbo.Products 
                                            INNER JOIN dbo.Categories ON dbo.Products.CategoryID = dbo.Categories.CategoryID 
                                            INNER JOIN dbo.ItemGrade ON dbo.Categories.GradeID = dbo.ItemGrade.GradeID WHERE (dbo.Categories.GradeID = '1070') OR (dbo.Categories.GradeID = '1071') ORDER BY ItemName ASC"></asp:SqlDataSource>
                                    </div>
                                </div>
                                <%--<div class="control-group">
                                    <label>Reusable Item :  </label>
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:DropDownList ID="ddWastageGodown" runat="server" DataSourceID="SqlDataSource14"
                                        DataTextField="StoreName" DataValueField="WID" CssClass="form-control"
                                        AutoPostBack="True" OnSelectedIndexChanged="ddGodown_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                ...
                                <div class="control-group">
                                    <label class="control-label">Wastage Godown Location : </label>
                                    <asp:DropDownList ID="ddWastageGodownLocation" runat="server" DataSourceID="SqlDataSource16"
                                        DataTextField="AreaName" DataValueField="AreaID" CssClass="form-control">
                                    </asp:DropDownList>
                                ...
                                <div class="table-responsive" style="display: inline-block;">
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView2_OnRowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ProcessedItemId" HeaderText="Processed Item" SortExpression="ProcessedItemId" />
                                            <asp:BoundField DataField="DozingMixingItemGroup" HeaderText="DM Item Group" SortExpression="ItemGroup" />
                                            <asp:BoundField DataField="DozingMixingItemSubGroup" HeaderText="DM Sub Group" SortExpression="SubGroup" />
                                            <asp:BoundField DataField="DozingMixingItemGrade" HeaderText="DM Grade" SortExpression="Grade" />
                                            <asp:BoundField DataField="DozingMixingItemCategory" HeaderText="DM Category" SortExpression="Category" />
                                            <asp:BoundField DataField="DozingMixingItem" HeaderText="DM Item Name" SortExpression="ItemName" />
                                            <asp:BoundField DataField="ConsumptionPercentage" HeaderText="Consumption (%)" SortExpression="ConsumedWeight" />
                                            <asp:BoundField DataField="Consumption" HeaderText="Consumption (%)" SortExpression="ConsumedWeight" Visible="False" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource7" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT Id, ProcessedItemId, DozingMixingItemGroup, DozingMixingItemSubGroup, DozingMixingItemGrade, DozingMixingItemCategory, DozingMixingItem, Consumption FROM DozingMixing WHERE ProcessedItemId = @ProccessedItemId"
                                        DeleteCommand="Delete [DozingMixing] WHERE Id=@Id">
                                        <SelectParameters>
                                            ...
                                            <asp:ControlParameter ControlID="ddOutItem" Name="ProccessedItemId" PropertyName="SelectedValue" Type="String" />
                            ...
                            <div class="form-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT pid, ProductionID, Date, MachineNo, LineNumber, Shift, Operation, OperatorID, Purpose, CustomerID, Brand, PackSize, ItemSubGroup, Grade, Category, ItemID, Color, CycleTime, CavityPcs, WorkingHour, TimeWaste,ReasonWaist, CalcProduction, ActProduction, Rejection, NetProduction, ItemWeight, TotalWeight, ActualWeight, Expr1, ItemName, FinalProduction, WasteWeight, ReUsableItem, Remarks, EntryBy FROM ProductionOutput WHERE  ProductionID <> ' ' AND EntryType = 'ProductionOutput' ORDER BY Date DESC"
                                        DeleteCommand="Delete ProductionOutput where pid='0'"></asp:SqlDataSource>
                                    <%--<asp:SqlDataSource ID="SqlDataSource13" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT pid, ProductionID, Date, MachineNo, LineNumber, Shift, Operation, OperatorID, Purpose, CustomerID, Brand, PackSize, ItemSubGroup, Grade, Category, ItemID, Color, CycleTime, CavityPcs, WorkingHour, TimeWaste,ReasonWaist, CalcProduction, ActProduction, Rejection, NetProduction, ItemWeight, TotalWeight, ActualWeight, Expr1, ItemName, FinalProduction, WasteWeight, ReUsableItem, Remarks, EntryBy
                                    FROM vw_PrdnOutput
                                    WHERE  ProductionID <> ' ' ORDER BY Date DESC"
                                        DeleteCommand="Delete ProductionOutput where pid='0'" ></asp:SqlDataSource>--%>
                                </div>
