<%@ Page  Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-Adj-Others.aspx.cs" Inherits="app_Stock_Adj_Others" %>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField  DataField="ProductName" HeaderText="Details" />
                            ...
                            OnRowDataBound="ItemGrid_RowDataBound" OnRowDeleted="GridView1_OnRowDeleted" OnSelectedIndexChanged="ItemGrid_SelectedIndexChanged" DataSourceID="SqlDataSource12" DataKeyNames="EntryID" >
                                ...
                                <asp:TemplateField ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="ItemSerialNo" HeaderText="Details" SortExpression="OutWeight" />
...
(SELECT [DepartmentName] FROM [Colors] WHERE Departmentid=Stock.Color) AS Color, ItemSerialNo, Price,
