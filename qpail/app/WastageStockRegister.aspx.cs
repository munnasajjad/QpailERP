...
public partial class app_WastageStockRegister : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/WastageStockRegister.aspx?godown=" + ddGodown.SelectedValue + "&location=" + ddLocation.SelectedValue + "&purpos=" + ddPurpose.SelectedValue + "&subgro=" + ddSubGroup.SelectedValue + "&Grade =" + ddGrade.SelectedValue + "&Category=" + ddcategory.SelectedValue + "&Type=" + ddType.SelectedValue + "&dateForm=" + dateForm + "&dateTo=" + dateTo;
    ...
    private DataTable BindItemGrid()
    {
        ...
        try
        {
            ...
            if (txtDateTo.Text != "")
            {
                date = " AND EntryDate<='" + Convert.ToDateTime(txtDateTo.Text).ToString("yyyy-MM-dd") + "' ";
