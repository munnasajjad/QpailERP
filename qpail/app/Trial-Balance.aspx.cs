...
public partial class app_Trial_Balance : System.Web.UI.Page
{
    ...
    protected void btnSearch_OnClick(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormTrialBalance.aspx?dateFrom=" + dt1+"&dateTo=" + dt2;
