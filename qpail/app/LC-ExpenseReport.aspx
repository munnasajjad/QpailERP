<%@ Page Title="LC-Expense Report" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LC-ExpenseReport.aspx.cs" Inherits="app_LC_ExpenseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">LC Expense Report</h3>
                                ...
                                <fieldset>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource9" runat="server"
                                        ...
                                        SelectCommand="SELECT [BrandID], BrandName FROM [RefItems] ORDER BY [BrandName]"></asp:SqlDataSource>
                                            ...
                                            <td> &nbsp; </td>--%>
                                            <td>
                                                <asp:DropDownList ID="ddType" runat="server" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="Type" DataValueField="Type" AutoPostBack="True">
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT DISTINCT UPPER(Type) AS Type FROM Party WHERE (Type = 'cnf') OR (Type = 'transport') OR (Type = 'insurance') ORDER BY Type"></asp:SqlDataSource>
