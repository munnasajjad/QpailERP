<%@ Page Title="Raw Stock Transfer" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Stock-Transfer.aspx.cs" Inherits="app_Stock_Transfer" %>
    ...
    <div class="row">
        <div class="col-md-4 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Raw Stock Transfer
                    </div>
                    <div class="tools">
                    ...
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="control-group">
                                <label class="control-label full-wdth">Date of Transfer: </label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label full-wdth">Transfer from Godown : </label>
                                <asp:DropDownList ID="ddGodownFrom" runat="server" DataSourceID="SqlDataSource6"
                            ...
                            <div class="control-group">
                                ...
                                <asp:DropDownList ID="ddLocationFrom" runat="server" DataSourceID="SqlDataSource15"
                                ...
                                <asp:SqlDataSource ID="SqlDataSource15" runat="server"
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddGodownFrom" Name="Warehouse" PropertyName="SelectedValue" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>

                            <div class="control-group">
                                <label class="control-label full-wdth">Transfer to Godown : </label>
                                <asp:DropDownList ID="ddGodownTo" runat="server" DataSourceID="SqlDataSource6"
                                    DataTextField="StoreName" DataValueField="WID" CssClass="form-control"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddGodown_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <asp:DropDownList ID="ddLocationTo" runat="server" DataSourceID="SqlDataSource16"
                                                  DataTextField="AreaName" DataValueField="AreaID" CssClass="form-control">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource16" runat="server"
                                                   ...
                                                   SelectCommand="SELECT AreaID,[AreaName] FROM [WareHouseAreas] where Warehouse=@Warehouse">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddGodownTo" Name="Warehouse" PropertyName="SelectedValue" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label full-wdth">Reason of transfer :</label>
                                <div class="controls">
                                ...
                                <asp:DropDownList ID="ddRemark" runat="server"  CssClass="form-control">
                                    <asp:ListItem>Loan Given</asp:ListItem>
                                    <asp:ListItem>Loan Received</asp:ListItem>
                                    <asp:ListItem>Wrong Entry</asp:ListItem>
                                    <asp:ListItem>No Clue</asp:ListItem>
                                </asp:DropDownList>
                                </div>
                            </div>
        ...
        <div class="col-md-8 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Transfer Item Details
                    </div>
                    <div class="tools">
                        <a href="" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                ...
                                <div class="row">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnAdd">
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                <label class="col-sm-12 control-label full-wdth">
                                                    Transfer Qty.(<asp:Literal ID="ltrUnit" runat="server" Visible="False" />pcs)</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                <label class="col-sm-12 control-label full-wdth">
                                                    Transfer Weight (<asp:Literal ID="Literal3" runat="server" Visible="False" />kg)</label>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField ItemStyle-Width="150px" DataField="ProductName" HeaderText="Product Name" ReadOnly="true"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="BrandID" HeaderText="Brand" Visible="False"/>
                                <asp:BoundField DataField="SizeId" HeaderText="Pack Size" Visible="False"/>
                                <asp:BoundField DataField="Color" HeaderText="Color" Visible="False"/>
                                <asp:BoundField  DataField="Spec" HeaderText="Spec" ReadOnly="true" Visible="False"></asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Adjust Weight">
                                    <ItemTemplate>
    ...
    <div class="row">
        <div class="col-md-12 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Item Stock Transfer History
                    </div>
                    <div class="tools">
                        <a href="" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" SelectedRowStyle-BackColor="LightBlue"
                            ...
                            <Columns>
                              ...
                              <asp:BoundField DataField="Godown" HeaderText="Godown" SortExpression="EntryType" />
                               <%--   <asp:BoundField DataField="InvoiceID" HeaderText="InvoiceID" SortExpression="InvoiceID" />--%>
                                ...
                                <asp:BoundField DataField="BrandID" HeaderText="Brand" SortExpression="BrandID" Visible="False"/>
                                <asp:BoundField DataField="SizeID" HeaderText="Size" SortExpression="SizeID" Visible="False"/>
                                <asp:BoundField DataField="Color" HeaderText="Color" SortExpression="Color" Visible="False"/>
                                <asp:BoundField DataField="Spec" HeaderText="Spec" SortExpression="Spec" Visible="False"/>
...
(SELECT [StoreName] FROM [Warehouses] WHERE  WID=Stock.WarehouseID) AS Godown, 
                                    [InQuantity], [OutQuantity], [InWeight], [OutWeight], price, Remark FROM [Stock] WHERE ([ProductID] = @ProductID) AND EntryType='Stock Transfer'
