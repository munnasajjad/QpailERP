<%@ Page Title="Stock Transaction" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="StockTransaction.aspx.cs" Inherits="app_StockTransaction" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title">Stock Transaction Entry</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="portlet-body form">
                        <div class="form-horizontal">
                            ...
                            <asp:Panel ID="pnl3" runat="server" DefaultButton="btnAdd">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Stock (Out) :</label>
                                    <div class="controls">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:DropDownList ID="ddHead5Cr" runat="server" CssClass="form-control select2me"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Kg.-Rate-Pcs.-Amount :</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtKg" runat="server" Text="0" Width="17.5%" onkeyup="calTtl()"></asp:TextBox>
                                        <asp:TextBox ID="txtRate" runat="server" Text="0" Width="17.5%" onkeyup="calTtl()"></asp:TextBox>
                                        <asp:TextBox ID="txtPcs" runat="server" Text="0" Width="17.5%"></asp:TextBox>
                                        <asp:TextBox ID="txtAmount" runat="server" Text="0" Width="17.5%"></asp:TextBox>
                                        ...
                                        <div>
                                            <asp:Button ID="btnAdd" runat="server" style="width:19%; float: right;" Text="Add to Grid" OnClick="btnAdd_Click" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView2" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Stock Head (In)" SortExpression="CrID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblHeadNameDr" runat="server" Text='<%# Bind("AccountsHeadDrName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Stock Head (Out)" SortExpression="CrID">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Kg." SortExpression="CrID">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Pcs." SortExpression="CrID">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPcs" runat="server" Text='<%# Bind("Pcs") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ShowHeader="False">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="ImageButton2" PopupControlID="PNL" OkControlID="ButtonOk" CancelControlID="ButtonCancel" BackgroundCssClass="modalBackground" />
            ...
            <div class="col-md-6">
                <div class="portlet box red">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i>
                            <asp:Literal ID="Literal1" runat="server" Text="Stock Transactions List" />
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="VoucherAmount" HeaderText="Amount" ItemStyle-HorizontalAlign="Right" SortExpression="VoucherAmount" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server"
                            ...
                            SelectCommand="SELECT VID, [VoucherNo], [VoucherDate], [VoucherDescription], [VoucherAmount] FROM [VoucherMaster] WHERE ([VoucherDate] = @VoucherDate) AND Voucherpost<>'C' AND (VoucherNo Not Like 'Auto%') AND (ParticularID='0101' OR ParticularID='0102' OR ParticularID='0103' OR ParticularID='0104' OR ParticularID='0105' OR ParticularID='0106') ORDER BY [VID] DESC"
                            DeleteCommand="Delete [VoucherDetails] where [SerialNo]=0">
                            <SelectParameters>
