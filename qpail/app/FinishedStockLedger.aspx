<%@ Page Title="Finished Stock Ledger" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="FinishedStockLedger.aspx.cs" Inherits="app_FinishedStockLedger" %>
                ...
                <div id="qPanel">
                    <div id="datePanel">
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList ID="ddWarehouse" runat="server" DataTextField="StoreName" DataValueField="WID" DataSourceID="SqlDataSource1"
                                Width="120px" AppendDataBoundItems="True" CssClass="select2me" OnSelectedIndexChanged="ddParties_SelectedIndexChanged" AutoPostBack="True">
                            ...
                            <asp:DropDownList ID="ddParties" runat="server" DataTextField="ProductName" DataValueField="pid" DataSourceID="SqlDataSource2"
                                Width="300px" AppendDataBoundItems="True" CssClass="select2me" OnSelectedIndexChanged="ddParties_SelectedIndexChanged" AutoPostBack="True">
                                <asp:ListItem>---Select---</asp:ListItem>
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:LocalSqlServer %>"
                                SelectCommand="SELECT pid, ProductName +' > '+(SELECT Company FROM Party WHERE PartyID=FinishedProducts.CompanyID) AS ProductName FROM FinishedProducts"></asp:SqlDataSource>
