...
public partial class app_CategoryWiseStock : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
      //  BindItemGrid();
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormCategoryWiseStock.aspx?subgro=" + ddSubGroup.SelectedValue + "&dt1=" + dt1 + "&dt2=" + dt2;
