<%@ Page Title="Stock Register for IML Items" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="StockRegisterForIMLItems.aspx.cs" Inherits="app_StockRegisterForIMLItems" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Stock Register For IML Items</h3>
                ...
                <div class="col-lg-12">
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>IML Items
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4" id="tinPlate" runat="server">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT GradeID, GradeName FROM ItemGrade WHERE CategoryID='35' ORDER BY [GradeName]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
