<%@ Page  Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Plastic-Container.aspx.cs" Inherits="app_Plastic_Container" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Plastic Container</h3>
                            ...
                            <div class="form-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [MachineNo], [mid] FROM [Machines] where Section=@Section ORDER BY [MachineNo]"><SelectParameters>
                                            <asp:ControlParameter ControlID="ddSection" Name="Section" PropertyName="SelectedValue" />
...
FROM                            PrdPlasticContDetails WHERE (PrdnID =(SELECT TOP (1) ProductionID FROM PrdPlasticCont WHERE (MachineNo = '4') ORDER BY pid DESC))"
                                    DeleteCommand="Delete FROM [PrdPlasticContDetails] where PrdnID='0'  ">
                                    <SelectParameters>
                ...
                <div class="col-md-6 ">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            ...
                            ItemName, FinalProduction, WasteWeight, ReUsableItem, Remarks, EntryBy FROM [PrdPlasticCont] a WHERE ProductionID<>'' ORDER BY [Date] desc"
