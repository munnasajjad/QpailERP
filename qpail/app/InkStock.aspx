<%@ Page Title="Ink Stock" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="InkStock.aspx.cs" Inherits="app_Ink_Stock" %>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Raw Stock Adjustment
                            </div>
                            <div class="tools">
                                    ...
                                    <div class="control-group hidden">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:DropDownList ID="ddRemark" runat="server" CssClass="form-control">
                                                <asp:ListItem>No Remarks</asp:ListItem>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4 ">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] WHERE (GroupID = @GroupID) AND CategoryID IN ('10','35','33','53','54')">
                                                            <SelectParameters>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label">Ink Name</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            Current Stock Weight (<asp:Literal ID="Literal3" runat="server" Visible="False" />kg)</label>
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="labelProductID" runat="server" CssClass="hidden" Text='<%# Bind("ProductID") %>'></asp:Label>
                                                <asp:Label ID="labelProductName" runat="server" CssClass="hidden" Text='<%# Bind("ProductName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:BoundField DataField="Purpose" HeaderText="Purpose" ReadOnly="true"></asp:BoundField>

                                        <asp:BoundField ItemStyle-Width="150px" DataField="ProductName" HeaderText="Ink Name" ReadOnly="true"></asp:BoundField>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="ProductID" HeaderText="ProductID" Visible="False"></asp:BoundField>


                                        <asp:BoundField DataField="SubGroup" HeaderText="SubGroup" />
                                        <asp:BoundField DataField="Specification" HeaderText="Specification" ReadOnly="true"></asp:BoundField>

                                        <%--<asp:TemplateField HeaderText="Adjust Qty." Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="lbliQty" runat="server" Text='<%# Bind("Quantity") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>--%>
                                        <asp:TemplateField HeaderText="Previous Stock Qty.">
                                            <ItemTemplate>
                                                <asp:Label ID="lbliQtyPrevious" runat="server" Text='<%# Bind("PreviousStockQuantity") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Consumed Weight">
                                            <ItemTemplate>
                                                <asp:Label ID="labelConsumedWeight" runat="server" Text='<%# Bind("ConsumedWeight") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Current Stock Qty.">
                                            <ItemTemplate>
                                                <asp:Label ID="lbliQtyCurrent" runat="server" Text='<%# Bind("CurrentStockQuantity") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            OnRowDataBound="GridView1_OnRowDataBound"  DataKeyNames="entryid"
                             DataSourceID="SqlDataSource12">--%>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    ...
                                    (Select Purpose from Purpose where pid=stock.Purpose) AS Purpose, [InvoiceID], [RefNo], [ProductName],
