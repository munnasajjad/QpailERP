<%@ Page Title="Subsidiary Accounts Ledger"  UICulture="bn-BD" Culture="bn-BD"  Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LedgerSub.aspx.cs" Inherits="app_LedgerSub" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <h3 class="page-title">
        <asp:Literal ID="ltrFrmName" runat="server" Text="Subsidiary Accounts Ledger" />
    </h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet box red">
                ...
                <div id="qPanel">
                    <div id="datePanel">
                        <asp:Label ID="Label2" runat="server" Text="Subsidiary A/C Name :"></asp:Label>
                        <asp:DropDownList ID="ddParties" runat="server" DataSourceID="SqlDataSource2"
                            DataTextField="AccountsName" DataValueField="AccountsID"
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                            ...
                            SelectCommand="SELECT AccountsID, AccountsName FROM [Accounts] ORDER BY [AccountsID]"></asp:SqlDataSource>
    ...
    <h4></h4>
    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped zebra" ForeColor="#046FAF"
