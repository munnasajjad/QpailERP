<%@ Page Title="Edit PO" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Order-Edit.aspx.cs" Inherits="app_Order_Edit" %>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Edit/ Cancel Sales Order
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                SelectCommand="SELECT [OrderID] FROM [Orders] WHERE CustomerName=@CustomerName AND ([DeliveryStatus] = 'A' OR [DeliveryStatus] = 'P')  AND OrderType='PO'">
                                                <SelectParameters>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Edit PO No. : </label>
                                        <div class="controls">
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnSave" CssClass="btn blue" runat="server" Text="Update Order" OnClick="btnSave_Click" />
                                    ...
                                    Total Weight: <asp:Literal ID="ltrWeight" runat="server"></asp:Literal> kg.
                                        ...
                                        <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover table-bordered"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Weight/Unit (gm)">
                                                    <ItemTemplate>
