<%@ Page Title="Raw Stock Consumption Report" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="FormRawStockConsumption.aspx.cs" Inherits="app_FormRawStockConsumption" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Raw Stock Consumption
                    </div>
                    <div class="tools">
                                ...
                                <div class="row">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnSearch">
                                        ...
                                        <div class="col-md-4" runat="server">
                                            <div class="control-group">
                                                <label class="control-label full-wdth">DateFrom : </label>
                                         ...
                                         <div class="col-md-4" runat="server">
                                            <div class="control-group">
                                                <label class="control-label full-wdth">DateTo : </label>
