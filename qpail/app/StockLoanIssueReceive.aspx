<%@ Page Title="Stock Loan Issue Receive" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="StockLoanIssueReceive.aspx.cs" Inherits="app_StockLoanIssueReceive" %>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Load Taken/ Loan Given :</label>
                                        <div class="controls">
                                            <%--<asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="" />--%>
                                            <asp:DropDownList ID="ddRemark" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddRemark_OnSelectedIndexChanged">
                                                <asp:ListItem Value="LT">Loan Taken</asp:ListItem>
                                                <asp:ListItem Value="LG">Loan Given</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <asp:DropDownList ID="ddFromGodown" runat="server" CssClass="form-control"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <asp:DropDownList ID="ddGodown" runat="server" CssClass="form-control"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddGodown_SelectedIndexChanged">
                                        </asp:DropDownList>
                        ...
                        <div class="portlet-body form">
                            ...
                            (Select Purpose from Purpose where pid=stock.Purpose) AS Purpose,
                             [InvoiceID], [RefNo], [ProductName],
                                ...
                                (SELECT [StoreName] FROM [WarehousesSisterConcern] WHERE WID=Stock.WarehouseID) AS Warehouse,
