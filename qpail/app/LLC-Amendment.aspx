<%@ Page Title="LLC Amendment" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LLC-Amendment.aspx.cs" Inherits="app_LLC_Amendment" %>
            ...
            <div class="row">
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i> LLC Amendment
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                SelectCommand="SELECT [OrderID] FROM [Orders] WHERE CustomerName=@CustomerName AND ([DeliveryStatus] = 'P' OR [DeliveryStatus] = 'A') AND OrderType='LC'">
                                                <SelectParameters>
                                     ...
                                     <div class="control-group">
                                        <label class="control-label full-wdth">Edit LLC No. : </label>
                                        <div class="controls">
                                            <asp:TextBox ID="txtEditLLC" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtTerms" runat="server" CssClass="form-control" TextMode="MultiLine" Height="60px" Width="310px" placeholder="" />
                                        </div>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Upload LLC Ammt. File: </label>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtPay" runat="server" CssClass="form-control" placeholder="Payable"  ReadOnly="true" ></asp:TextBox>
                                        </div>
                                    </div>


                                    <div class="control-group">
                                        <label class="control-label full-wdth">Ammendment No.:</label>
                                        <div class="controls">
                                            <asp:TextBox ID="txtAmdNo" runat="server" CssClass="form-control" placeholder="" />
                                        </div>
                                    </div>
                                    
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Ammendment Date : </label>
                                        <div class="controls">
                                            <asp:TextBox ID="txtAmdDate" runat="server" CssClass="form-control" placeholder="DD/MM/YYYY"></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                Enabled="True" TargetControlID="txtAmdDate">
                                            </asp:CalendarExtender>
                                        </div>
                                    </div>
                            ...
                            <div class="form-actions" style="margin-bottom: 100px;">
                                <asp:Button ID="btnSave" CssClass="btn blue" runat="server" Text="Update LLC" OnClick="btnSave_Click" />
                        ...
                        <asp:Button ID="btnPrint" CssClass="btn purple" runat="server" Text="Print" />--%>
                                <asp:Button ID="btnCancel" CssClass="btn default" runat="server" Text="Cancel Order" OnClick="btnCancel_Click" Visible="false" />
                            </div>
                ...
                <div class="col-md-8 ">
                            ...
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
                                   ...
                                   <div style="text-align:right;">
                                    ...
                                    Total Weight: <asp:Literal ID="ltrWeight" runat="server"></asp:Literal> gm.
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>LLC Ammendment History
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        ...
                        <div class="portlet-body form">
                            <div class="form-horizontal" role="form">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource9">
                                    <Columns>
                                        <asp:BoundField DataField="AmdNo" HeaderText="AmdNo" SortExpression="AmdNo" />
                                        <asp:BoundField DataField="AmdDate" HeaderText="AmdDate" SortExpression="AmdDate" />
                                        
                                        <asp:BoundField DataField="lcdate" HeaderText="LC Date" SortExpression="lcdate" />
                                        <asp:BoundField DataField="expDate" HeaderText="Exp.Date" SortExpression="lcNo" />
                                        <asp:BoundField DataField="deliveryDate" HeaderText="Del.Date" SortExpression="deliveryDate" />
                                        ...
                                        <asp:BoundField DataField="lcTerms" HeaderText="Terms & Conditions" SortExpression="lcTerms" />
                                    </Columns>
                                </asp:GridView>
                                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" 
                                    SelectCommand="SELECT [AmdNo], [AmdDate], [orderdate], [deliveryDate], [total], [vat], [payable], [piDate], [lcNo], [lcdate], ExpDate, [lcTerms] FROM [PIhistory] WHERE ([LLCNo] = @LLCNo) ORDER BY [sl]">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddOrders" Name="LLCNo" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>         
