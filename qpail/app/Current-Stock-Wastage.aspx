<%@ Page Title="Current Stock (Wastage)" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Current-Stock-Wastage.aspx.cs" Inherits="app_Current_Stock_Wastage" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i>Current Stock (Wastage)
                    </div>
                    <div class="tools">
