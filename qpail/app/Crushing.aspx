<%@ Page Title="Store Activities (Crushing)" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Crushing.aspx.cs" Inherits="app_Crushing" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Item Input
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddOutGodown" runat="server" DataSourceID="SqlDataSource7" DataTextField="StoreName" DataValueField="WID" CssClass="form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddOutLocation" runat="server" DataSourceID="SqlDataSource16" DataTextField="AreaName" DataValueField="AreaID" CssClass="form-control">
                                                        </asp:DropDownList>
                                                        <asp:SqlDataSource ID="SqlDataSource16" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            ...
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="ddOutGodown" Name="Warehouse" PropertyName="SelectedValue" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddCategory" runat="server" DataSourceID="SqlDataSource8a"
                                                            AutoPostBack="true" OnSelectedIndexChanged="ddCategory_SelectedIndexChanged"
                                                            DataTextField="CategoryName" DataValueField="CategoryID">
                                                        </asp:DropDownList>

                                                        <asp:SqlDataSource ID="SqlDataSource8a" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            In/ Out  Qty.(<asp:Literal ID="ltrUnit" runat="server" Visible="False" />pcs)</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            In/ Out  Weight (<asp:Literal ID="Literal3" runat="server" Visible="False" />kg)</label>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Item Output
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        ...
                        <div class="portlet-body form">
                            <div class="form-horizontal" role="form">
                                <div class="form-body">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddGodown" runat="server" DataSourceID="SqlDataSource6" DataTextField="StoreName" DataValueField="WID" CssClass="form-control"
                                                            AutoPostBack="True" OnSelectedIndexChanged="ddGodown_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                ...
                                                <div class="col-md-4 hidden">
                                                    <div class="control-group">
                                                        <label>Purpose :</label>
                                                        <asp:DropDownList ID="ddPurposeOut" runat="server" DataSourceID="SqlDataSource13a"
                                                            DataTextField="Purpose" DataValueField="pid" AutoPostBack="True" OnSelectedIndexChanged="ddPurposeOut_OnSelectedIndexChanged">
                                                        </asp:DropDownList>
                                                        <asp:SqlDataSource ID="SqlDataSource13a" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT [pid], [Purpose] FROM [Purpose] order by Purpose"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label">Group</label>
                                                        <asp:DropDownList ID="ddGroupOut" runat="server" DataSourceID="SqlDataSource17" AutoPostBack="true"
                                                            DataTextField="GroupName" DataValueField="GroupSrNo" OnSelectedIndexChanged="ddGroupOut_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddSubgroupOut" runat="server" DataSourceID="SqlDataSource18" DataTextField="CategoryName" DataValueField="CategoryID"
                                                            AutoPostBack="True" OnSelectedIndexChanged="ddSubgroupOut_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                        <asp:SqlDataSource ID="SqlDataSource18" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] where (GroupID = @GroupID) ">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="ddGroupOut" Name="GroupID" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddGradeOut" runat="server" DataSourceID="SqlDataSource19"
                                                            AutoPostBack="true" OnSelectedIndexChanged="ddGradeOut_SelectedIndexChanged"
                                                            DataTextField="GradeName" DataValueField="GradeID">
                                                        </asp:DropDownList>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource19" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT GradeID,GradeName from ItemGrade where CategoryID = @CategoryID ORDER BY [GradeName]">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="ddSubGroupOut" Name="CategoryID" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddCategoryOut" runat="server" DataSourceID="SqlDataSource8"
                                                            AutoPostBack="true" OnSelectedIndexChanged="ddCategoryOut_SelectedIndexChanged"
                                                            DataTextField="CategoryName" DataValueField="CategoryID">
                                                        </asp:DropDownList>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT CategoryID, CategoryName FROM [Categories] where GradeID = @GradeID ORDER BY [CategoryName]">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="ddGradeOut" Name="GradeID" PropertyName="SelectedValue" />
                                                            </SelectParameters>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddProductOut" runat="server" DataSourceID="SqlDataSource21"
                                                            AutoPostBack="true" OnSelectedIndexChanged="ddProductOut_SelectedIndexChanged"
                                                            DataTextField="ItemName" DataValueField="ProductID">
                                                        </asp:DropDownList>
                                                        <asp:SqlDataSource ID="SqlDataSource21" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                            SelectCommand="SELECT ProductID, [ItemName] FROM [Products] WHERE [CategoryID] = @CategoryID ORDER BY [ItemName]">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="ddCategoryOut" Name="CategoryID" PropertyName="SelectedValue" />
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                                        <%--SelectCommand="SELECT ProductID, [ItemName] FROM [Products] WHERE ([CategoryID] IN (Select CategoryID from Categories where GradeID IN (Select GradeID from ItemGrade where CategoryID in (Select CategoryID from ItemSubGroup where GroupID=2 AND ProjectID=1)))) ORDER BY [ItemName]"></asp:SqlDataSource>--%>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="control-label full-wdth">Description : </label>
                                                        <asp:TextBox ID="txtDescOut" runat="server" CssClass="form-control" placeholder=""></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="col-md-4 hidden" id="ddTypeAreaOut" runat="server">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">Stock Type</label>
                                                        <asp:DropDownList ID="ddTypeOut" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddTypeOut_OnSelectedIndexChanged">
                                                            <asp:ListItem>Raw Sheet</asp:ListItem>
                                                            <asp:ListItem>Processed Sheet</asp:ListItem>
                                                            <asp:ListItem>Printed Sheet</asp:ListItem>
                                                        </asp:DropDownList>
                                                ...
                                                <asp:Panel ID="pnlExtraOut" runat="server">

                                                    <div class="col-md-4">
                                                        <div class="control-group hidden">
                                                            <label class="col-sm-12 control-label">Company:</label>
                                                            <asp:DropDownList ID="ddCustomerOut" runat="server" DataSourceID="SqlDataSource22"
                                                                DataTextField="Company" DataValueField="PartyID" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddCustomerOut_OnSelectedIndexChanged">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="control-group hidden">
                                                            <label class="col-sm-12 control-label">Brand: </label>
                                                            <asp:DropDownList ID="ddBrandOut" runat="server" DataSourceID="SqlDataSource23" DataTextField="BrandName" DataValueField="BrandID" AppendDataBoundItems="True"
                                                                AutoPostBack="True" OnSelectedIndexChanged="ddBrandOut_OnSelectedIndexChanged">
                                                                <asp:ListItem Value="">--- all ---</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:SqlDataSource ID="SqlDataSource23" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                                SelectCommand="SELECT [BrandID], [BrandName] FROM [CustomerBrands] WHERE (([CustomerID] = @CustomerID) AND ([ProjectID] = @ProjectID)) Order by BrandName">
                                                                <SelectParameters>
                                                                    <asp:ControlParameter ControlID="ddCustomerOut" Name="CustomerID" PropertyName="SelectedValue" Type="String" />
                                                                    <asp:ControlParameter ControlID="lblProject" Name="ProjectID" PropertyName="Text" Type="String" />
                                                                </SelectParameters>
                                                            </asp:SqlDataSource>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="control-group hidden">
                                                            <label class="col-sm-12 control-label full-wdth">Pack-Size</label>
                                                            <asp:DropDownList ID="ddSizeOut" runat="server" DataSourceID="SqlDataSource24" DataTextField="BrandName" DataValueField="BrandID"
                                                                AutoPostBack="True" OnSelectedIndexChanged="ddSizeOut_OnSelectedIndexChanged">
                                                            </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-4 hidden">
                                                        <div class="control-group">
                                                            <label class="control-label">Color :  </label>
                                                            <asp:DropDownList ID="ddColorOut" runat="server" DataSourceID="SqlDataSource25" DataTextField="DepartmentName" DataValueField="Departmentid"
                                                                AutoPostBack="True" OnSelectedIndexChanged="ddColorOut_OnSelectedIndexChanged">
                                                            </asp:DropDownList>
                                                ...
                                                <asp:Panel ID="pnlSpecOut" runat="server">

                                                    <div class="col-md-4">
                                                        <div class="control-group hidden">
                                                            <label class="col-sm-12 control-label full-wdth">
                                                                Specification:
                                                        <asp:LinkButton ID="lbSpecOut" runat="server" OnClick="lbSpecOut_OnClick">New</asp:LinkButton>
                                                                |
                                                        <asp:LinkButton ID="lbFilterOut" runat="server" OnClick="lbFilterOut_OnClick">Show-all</asp:LinkButton>
                                                            </label>
                                                            <asp:DropDownList ID="ddSpecOut" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddSpecOut_OnSelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            <asp:SqlDataSource ID="SqlDataSource26" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                                SelectCommand="SELECT [id], [spec] FROM [Specifications] ORDER BY [spec]"></asp:SqlDataSource>

                                                            <asp:TextBox ID="txtSpecOut" runat="server" Visible="False" />
                                                        </div>
                                                    </div>
                                                </asp:Panel>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            Current Stock Qty.(<asp:Literal ID="Literal2" runat="server" Visible="False" />pcs)</label>
                                                        <asp:TextBox ID="txtCurrentQtyOut" runat="server" ReadOnly="True" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            Current Stock Weight
                                                    (<asp:Literal ID="Literal7" runat="server" Visible="False" />kg)</label>
                                                        <asp:TextBox ID="txtCurrentWeightOut" runat="server" ReadOnly="True" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            In/ Out  Qty.(<asp:Literal ID="ltrUnitOut" runat="server" Visible="False" />pcs)</label>
                                                        <asp:TextBox ID="txtQtyOut" runat="server" onkeyup="calTotal()" />
                                                        <asp:Literal ID="ltrCQtyOut" runat="server" Visible="False" />

                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender4"
                                                            runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789" TargetControlID="txtQtyOut">
                                                        </asp:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            In/ Out  Weight (<asp:Literal ID="Literal10" runat="server" Visible="False" />kg)</label>
                                                        <asp:TextBox ID="txtWeightOut" runat="server" />
                                                        <asp:Literal ID="Literal11" runat="server" Visible="False" />

                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender5"
                                                            runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtWeightOut">
                                                        </asp:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 hidden" id="pnlUnitPrice">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">Unit Price</label>
                                                        <asp:TextBox ID="txtPriceOut" runat="server" Text="0" />
                                                        <asp:Literal ID="Literal12" runat="server" Visible="False" />
                                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender6"
                                                            runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars="0123456789." TargetControlID="txtPriceOut">
                                                        </asp:FilteredTextBoxExtender>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <div style="margin-top: 29px">
                                                            <asp:Button ID="btnAddOut" runat="server" Text="Add" Width="100px" OnClick="btnAddOut_Click" />
                                    ...
                                    Total :
                                    <asp:Literal ID="ltrQtyOut" runat="server"></asp:Literal>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemOutGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue" Width="100%"
                                    OnRowDataBound="ItemOutGridView_RowDataBound" OnRowDeleting="ItemOutGridView_RowDeleting" OnSelectedIndexChanged="ItemOutGridView_SelectedIndexChanged">

                                    <Columns>
                                        <asp:TemplateField ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                <%#Container.DataItemIndex+1 %>
                                                <asp:Label ID="lblEntryOutId" runat="server" CssClass="hidden" Text='<%# Bind("Id") %>'></asp:Label>
                                            </ItemTemplate>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i>Save Crushing Data
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-horizontal" role="form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Crushing Date : </label>
                                        <div class="controls">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Item Crushing History
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
