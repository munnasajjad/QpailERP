<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LedgerControl.aspx.cs" Inherits="Application_Reports_LedgerControl" %>
...
<head id="Head1" runat="server">
    <title>Control Account Ledger</title>
...
<div id="content">
   <%-- <div id="rlogo">--%>
    ...
    <div id="qPanel">
        <div id="datePanel">
        <asp:Label ID="Label2" runat="server" Text="Control A/C:"></asp:Label> 
