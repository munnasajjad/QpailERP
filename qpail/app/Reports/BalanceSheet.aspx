<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BalanceSheet.aspx.cs" Inherits="Application_Reports_BalanceSheet" %>
...
<div id="content">
    ...
    <asp:Button ID="btnLoad" runat="server" Text="Generate Balance Sheet" OnClick="btnLoad_Click" />
...
<h4>Asset</h4>
 ...
 <p style="text-align:center; font-weight:bold;">Current Asset Value : 
    ...
    <h4>Capital</h4>
        ...
        <p style="text-align:center; font-weight:bold;">Net Balance: (Assets - Liabilities - Capital) : 
