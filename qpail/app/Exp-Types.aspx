<%@ Page Title="LC Expense Types" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Exp-Types.aspx.cs" Inherits="app_Exp_Types" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">LC Expense Types
                    </h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 ">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>LC Expense Types Setup
                            </div>
                            <div class="tools">
                            ...
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSave">
                                <div class="form-body">
                                    ...
                                    <div id="EditField" runat="server">
                                        ...
                                        <asp:DropDownList ID="DropDownList1" CssClass="form-control select2me" runat="server" DataSourceID="SqlDataSource3" DataTextField="ExpTypeName" DataValueField="ExpTypeName" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT [ExpTypeName] FROM [ExpTypes] ORDER BY [DisplaySl]"></asp:SqlDataSource>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDept" runat="server" CssClass="form-control" EnableViewState="true" 
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    DataSourceID="SqlDataSource1" Width="100%" DataKeyNames="ExpTypeName" OnRowDeleting="GridView1_OnRowDeleting">
                                    <Columns>                
                <asp:TemplateField ItemStyle-Width="40px">
                    <ItemTemplate>
                        <%#Container.DataItemIndex+1 %>
                                        ...
                                        <asp:TemplateField HeaderText="Expense Type" SortExpression="ExpTypeName" Visible="False">
                                            <ItemTemplate>
                                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("ExpTypesID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Expense Type" SortExpression="ExpTypeName">
                                            <ItemTemplate>
                                                <asp:Label ID="Label1y" runat="server" Text='<%# Bind("ExpTypeName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ...
                                    SelectCommand="SELECT ExpTypesID, [ExpTypeName], [Company], DisplaySl FROM [ExpTypes] Order by DisplaySl"
                                    UpdateCommand=""
                                    DeleteCommand="Delete ExpTypes where ExpTypesID=0"></asp:SqlDataSource>
