...
public partial class app_Cheque_Receipt_Payment : System.Web.UI.Page
{
        ...
        try
        {
            if (Convert.ToDateTime(txtDateFrom.Text) <= Convert.ToDateTime(txtDateTo.Text))
            {
                ...
                string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") +
                                  "XerpReports/FormCheque-Receipt-Payment.aspx?ReportTypeId=" + ddParties.SelectedValue + "&dateFrom=" + dt1 + "&dateTo=" + dt2;
