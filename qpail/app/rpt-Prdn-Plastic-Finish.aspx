<%@ Page Title="Plastic Finishing" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="rpt-Prdn-Plastic-Finish.aspx.cs" Inherits="app_rpt_Prdn_Plastic_Finish" %>
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnSearch">
                                        ...
                                        <div class="col-md-4" id="Div2" runat="server">
                                            <div class="control-group">
                                                ...
                                                <asp:DropDownList ID="ddBrand" runat="server" DataSourceID="SqlDataSource6" AppendDataBoundItems="True"
                                        ...
                                        <div class="col-md-4">
                                            <div class="control-group">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                    SelectCommand="SELECT CategoryID, CategoryName FROM [ItemSubGroup] where (CategoryID = '13') "></asp:SqlDataSource>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 hidden" id="Div1" runat="server">
                                            <div class="control-group">
