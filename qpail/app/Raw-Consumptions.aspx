<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Raw-Consumptions.aspx.cs" Inherits="app_Raw_Consumptions" %>
            ...
            <%--<asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
				...
				<div class="col-md-6 ">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> <asp:Literal ID="lrlSavedBox" runat="server"></asp:Literal>
							</div>
							<div class="tools">
								<a href="" class="collapse">
								</a>
