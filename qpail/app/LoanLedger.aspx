<%@ Page Title="Loans Ledger" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="LoanLedger.aspx.cs" Inherits="app_LoanLedger" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Loans Ledger</h3>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div id="Div2">
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" width="100%" style="width:100%" class="table1">
                                       <tr>
                                        ...
                                        <tr>
                                            <td>
                                                 <asp:DropDownList ID="ddLoanTypes" runat="server" DataSourceID="SqlDataSource8"  CssClass="form-control" AutoPostBack="True"
                                    DataTextField="LoanTypes" DataValueField="Id">
                                </asp:DropDownList>
                            ...
                            <td>
                                <asp:DropDownList ID="ddCode" runat="server" CssClass="form-control" Width="300px" DataSourceID="SqlDataSource4" DataTextField="Code" DataValueField="ID">
                                    
                                </asp:DropDownList>
                               <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:qpailerpConnectionString %>" 
                                   SelectCommand="SELECT [ID], [Code] FROM [BankLoan] WHERE LoanType=@LoanTypeId ">
                                   <SelectParameters>
                                       <asp:ControlParameter ControlID="ddLoanTypes" Name="LoanTypeId" PropertyName="SelectedValue" />
                                   </SelectParameters>
                               </asp:SqlDataSource>
                            </td>
                                            ...
                                            <td style="text-align: center;vertical-align: middle;">
                                                <asp:Button ID="btnSearch" CssClass="btn btn-s-md btn-primary" runat="server" Text="Show" OnClick="btnShow_Click" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                            ...
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="ddLoanTypes" Name="CustomerID" PropertyName="SelectedValue" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
