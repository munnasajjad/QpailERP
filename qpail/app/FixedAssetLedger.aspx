<%@ Page Title="Fixed Assets Ledger" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="FixedAssetLedger.aspx.cs" Inherits="app_FixedAssetLedger" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box green ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Fixed Assets Ledger
                    </div>
                    <div class="tools">
                                ...
                                <div class="row">
                                    ...
                                    <asp:Panel ID="pnlAdd" runat="server" DefaultButton="btnSearch">
                                        ...
                                        <div class="col-md-4 hidden">
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">LC No/ Invoice No :</label>
                                                    <asp:DropDownList ID="ddlcinv" runat="server" DataSourceID="SqlDataSource2" DataTextField="LCNoFTT" DataValueField="LCNoFTT" AutoPostBack="True" ></asp:DropDownList>
                                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:qpailerpConnectionString %>" SelectCommand="SELECT DISTINCT  [LCNoFTT],[ProductID] FROM [FixedAssets] WHERE [ProductID]=@ProductID ">
                                                    <SelectParameters>
                                            ...
                                            <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">Date From</label>
                                                    <asp:TextBox ID="txtDatefrom1" runat="server" />
                                                    <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                                        Enabled="True" TargetControlID="txtDatefrom1">
                                                    </asp:CalendarExtender>
                                        ...
                                        <div class="col-md-4">
                                                <div class="control-group">
                                                    <label class="col-sm-12 control-label full-wdth">Date To</label>
                                        ...
                                        <%-- New added Code --%>
                                        <div class="col-md-4 hidden" runat="server">
                                            <div class="control-group">
