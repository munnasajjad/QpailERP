<%@   Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Party.aspx.cs" Inherits="app_Party" %>
                        ...
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                ...
                                <div class="control-group hidden">
                                    ...
                                    <asp:DropDownList ID="ddPartyType" runat="server">
                                        ...
                                        <asp:ListItem Value="transport">Transport Agent</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div id="divIncCode" runat="server" class="control-group" Visible="False">
                                    <asp:Label ID="LblInsurance" runat="server" Text="Insurance Code"></asp:Label>
                                    <asp:TextBox ID="txtInsuranceCode" Text="0" runat="server"></asp:TextBox>
                                </div>
                                ...
                                <asp:Panel ID="TermsPanel" runat="server" Visible="False">
                                    ...
                                    <div class="control-group">
                                        <asp:Label ID="Label9" runat="server" Text="VAT Reg. No. : "></asp:Label>
                                        <asp:TextBox ID="txtVatRegNo" runat="server" CssClass="form-control" />
                                    </div>
                                    <div class="control-group">
                                        <asp:Label ID="Label14" runat="server" Text="TDS Terms : "></asp:Label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12 control-label">A/c Head VDS </label>
                                        <asp:DropDownList ID="ddAccHeadVDS" runat="server" AutoPostBack="True" AppendDataBoundItems="True" CssClass="form-control select2me" DataSourceID="SqlDataSource5" DataTextField="AccountsHeadName" DataValueField="AccountsHeadID">
                                            <asp:ListItem Value="0">---Select---</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                                           SelectCommand="Select AccountsHeadID, (Select ControlAccountsName from ControlAccount where ControlAccountsID='010163')+' > '+AccountsHeadName as AccountsHeadName from [HeadSetup] Order by AccountsHeadID"></asp:SqlDataSource>
                                    </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" Width="150%" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ReferrenceItems" HeaderText="Ref. Items" SortExpression="ReferrenceItems" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT PartyID, [Company], [Zone], [ReferrenceItems], [Address], [Phone], [ContactPerson], [MobileNo] FROM [Party] WHERE (([Type] = @Type) AND ([ProjectID] = @ProjectID)) order by Company">
                                        <SelectParameters>
                                            <asp:QueryStringParameter Name="Type" QueryStringField="type" Type="String" />
                                            <asp:SessionParameter Name="ProjectID" SessionField="ProjectID" Type="Int32" />
                                        </SelectParameters>
