...
public partial class Current_Stock_Processed : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormCurrentStockProcessed.aspx?godown=" + ddGodown.SelectedValue + "&location=" + ddLocation.SelectedValue + "&purpos=" + ddPurpose.SelectedValue + "&subgro=" + ddSubGroup.SelectedValue + "&cust=" + ddCustomer.SelectedValue + "&dt1=" + dt1;
    ...
    private DataTable BindItemGrid()
    {
        ...
        try
        {
            ...
            {
                query += " AND Customer='" + ddCustomer.SelectedValue + "' ";
            }
            ds = SQLQuery.ReturnDataSet(@"SELECT DISTINCT (SELECT StoreName FROM Warehouses WHERE (WID = Stock.WarehouseID)) AS Warehouse, 
    ...
    {
        exportExcel(BindItemGrid(), "Processed Stock");
    }
