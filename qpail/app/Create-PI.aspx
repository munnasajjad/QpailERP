<%@ Page Title="New Proforma Invoice" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Create-PI.aspx.cs" Inherits="app_Create_PI" %>
            ...
            <div class="row">
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Create New Proforma Invoice
                            </div>
                            <div class="tools">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtPODate" runat="server" CssClass="form-control" placeholder="DD/MM/YYYY" Enabled="false"></asp:TextBox>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:TextBox ID="txtInv" runat="server" CssClass="form-control" placeholder="Proforma Invoice No."></asp:TextBox>                                            
                                        </div>
                                    </div>
                                    ...
                                    <%--<div class="control-group">
                                        <label class="control-label full-wdth">PO No. : </label>
                                        <div class="controls">
                                            <asp:TextBox ID="txtPI" runat="server" CssClass="form-control" placeholder="Purchase Order No."></asp:TextBox>                                            
                                        </div>
                                    </div>--%>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Terms & Conditions:</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Upload PI Documents: </label>
                                        <div class="controls">
                ...
                <div class="col-md-8 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>PI Item Details
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
