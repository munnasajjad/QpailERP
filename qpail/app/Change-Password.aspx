<%@ Page Title="" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Change-Password.aspx.cs" Inherits="Cells_Change_Password" %>
        ...
        <ChangePasswordTemplate>
									...
									<li>
								        <div class="form_grid_12">
									        <label class="field_title"><asp:Label ID="CurrentPasswordLabel" runat="server"     AssociatedControlID="CurrentPassword">Current Password:</asp:Label></label>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title"><asp:Label ID="NewPasswordLabel" runat="server"  AssociatedControlID="NewPassword">New Password:</asp:Label></label>
									<div class="form_input">
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title"><asp:Label ID="ConfirmNewPasswordLabel" runat="server" AssociatedControlID="ConfirmNewPassword">Confirm New Password:</asp:Label></label>
									<div class="form_input">
