...
public partial class app_Current_Stock_Wastage : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormCurrentStockWastage.aspx?godown=" + ddGodown.SelectedValue    + "&subgro=" + ddSubGroup.SelectedValue + "&dt1=" + dt1;
    ...
    {
        exportExcel(BindItemGrid(), "Current-Stock-Wastage-Report");
    }
