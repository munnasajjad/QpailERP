...
public partial class app_Item_Purchase_History : System.Web.UI.Page
{
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        try
        {
            if (Convert.ToDateTime(txtDateFrom.Text) <= Convert.ToDateTime(txtDateTo.Text))
            {
                ...
                string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/FormItem-Purchase-History.aspx?Group=" + ddGroup.SelectedValue + "&SubGrp=" + ddSubGrp.SelectedValue + "&Grade=" + ddGrade.SelectedValue + "&Category=" + ddCategory.SelectedValue + "&ItemName=" + ddItemName.SelectedValue + "&dt1=" + dtFrom + "&dt2=" + dtTo;
