<%@ Page Title="Cushing Section" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="CrushingSection.aspx.cs" Inherits="app_CrushingSection" %>
            ...
            <div class="row">
                <div class="col-md-8 ">
                    ...
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Crushing Input
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4" id="ddTypeArea" runat="server">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">Item Type</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            Crushing Qty.(<asp:Literal ID="ltrUnit" runat="server" Visible="False" />pcs)</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        <label class="col-sm-12 control-label full-wdth">
                                                            Crushing Weight
                                                            <asp:Literal ID="Literal3" runat="server" Visible="False" />kg</label>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="ItemGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" SelectedRowStyle-BackColor="LightBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Crushing Qty.">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Crushing Weight">
                                            <ItemTemplate>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Crushing Output
                            </div>
                            <div class="tools">
                                <a href="" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Item Selection : </label>
                                        <asp:DropDownList ID="ddItemSelection" runat="server" DataSourceID="SqlDataSource13"
                                            DataTextField="ItemName" DataValueField="ProductID" CssClass="form-control">
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource13" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                            SelectCommand="SELECT P.ProductID, CONCAT(C.CategoryName, '>>', P.ItemName) AS ItemName FROM Products AS P INNER JOIN Categories AS C ON P.CategoryID = C.CategoryID WHERE C.CategoryID = '3570' ORDER BY ItemName">
                                            <%--<SelectParameters>
                                                <asp:ControlParameter ControlID="ddGodown" Name="Warehouse" PropertyName="SelectedValue" />
                                            </SelectParameters>--%>
                                        </asp:SqlDataSource>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label full-wdth">Weight (KG) : </label>
                                        <asp:TextBox ID="txtCrushingWeight" runat="server"/>
                                        <asp:Literal ID="Literal6" runat="server" Visible="False" />

                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender3"
                                            runat="server" Enabled="True" FilterType="Custom, Numbers" ValidChars=".-0123456789" TargetControlID="txtCrushingWeight">
                                        </asp:FilteredTextBoxExtender>
                                    </div>

                                <div class="control-group">
                                    <label class="control-label full-wdth">Crushing Remark :</label>
                                    <div class="controls">
