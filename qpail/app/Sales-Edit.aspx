<%@ Page Title="Edit Sales" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Sales-Edit.aspx.cs" Inherits="app_Sales_Edit" %>
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label>Invoice No.:</label>
                                    ...
                                    <asp:DropDownList ID="ddInvoice" runat="server" Width="70%"
                                        DataSourceID="SqlDataSource9" DataTextField="InvNo" DataValueField="InvNo" CssClass="select2me"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddInvoice_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" 
                                        SelectCommand="SELECT [InvNo] FROM [Sales] ORDER BY [SaleID] desc">
                                        <SelectParameters>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <asp:DropDownList ID="ddCustomer" runat="server" DataSourceID="SqlDataSource1" DataTextField="Company" DataValueField="PartyID"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddCustomer_SelectedIndexChanged" CssClass="select2me" Width="70%">
                                    </asp:DropDownList>
                                ...
                                <div class="controls">
                                    <%--<asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="" />--%>
                                       <asp:DropDownList ID="ddAddress" runat="server" DataSourceID="SqlDataSource3" 
                                           DataTextField="DeliveryPointName" DataValueField="DeliveryPointsID"  CssClass="select2me" Width="70%">
                                    </asp:DropDownList>
                            ...
                            <div class="control-group hidden">
                                <label>Invoice Maturity Days : </label>
                                <div class="controls">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <asp:DropDownList ID="ddWarehouse" runat="server" DataSourceID="SqlDataSource2" DataTextField="StoreName" DataValueField="WID" CssClass="select2me" Width="70%">
                                    </asp:DropDownList>
                            ...
                            <div class="form-group">
                                <label>No. of Carton/ Bag/ Pack : </label>
                                <div class="controls">
                            ...
                            <asp:Panel ID="pnlReturn" Runat="server" Visible="True">
                            <div class="control-group red">
                                <label>Return Date :</label>
                                <div class="controls">
                                    <asp:TextBox ID="txtRDate" runat="server" CssClass="form-control" />
                                    <asp:CalendarExtender ID="CalendarExtender6" runat="server" Format="dd/MM/yyyy"
                                        Enabled="True" TargetControlID="txtRDate">
                                    </asp:CalendarExtender>
                                </div>
                            </div>
                                </asp:Panel>
                    ...
                    <div class="form-actions">
                        ...
                        <asp:Button ID="btnDelete" CssClass="btn default" runat="server" Text="Sales Return" OnClick="btnDelete_OnClick" />
                        
                                                        <asp:ConfirmButtonExtender TargetControlID="btnDelete" ID="confBtnDelete" runat="server" DisplayModalPopupID="ModalPopupExtender1">
                                                        ...
                                                        <asp:Panel ID="PNL" runat="server" Style="display: none; width: 300px; background-color: White; border-width: 2px; border-color: Black; border-style: solid; padding: 20px;">
                                                            <b style="color: red">Invoice will be deleted permanently!</b><br />
