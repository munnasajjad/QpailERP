<%@ Page Title="Document Library" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Documents-Upload.aspx.cs" Inherits="app_Documents_Upload" %>
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <asp:AsyncFileUpload ID="ThumbUpload" runat="server" UploaderStyle="Modern" CssClass="inputfile" />
            ...
            <div class="span12">
                <div class="portlet box yellow">
                    ...
                    <div class="portlet-body">
                         ...
                         <div class="control-group">
                            <label class="control-label">Search Uploaded Files By</label>
                            <div class="controls">
