<%@ Page Title="Sales by Items" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Sale-Item-Report.aspx.cs" Inherits="Operator_Sale_Item_Report" %>
                    ...
                    <div class="portlet box light-grey" style="min-height: 355px;">
                        ...
                        <iframe id="if1" runat="server" height="800px" width="100%" ></iframe>
                                ...
                                <asp:GridView ID="GVrpt" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_1_info"
                                    ...
                                    DataKeyNames="InvNo" RowStyle-CssClass="odd gradeX" OnRowDataBound="GVrpt_RowDataBound">
                                    <Columns>
