<%@ Page Title="Invoice By Payment Status" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Invoice-Pay-Status.aspx.cs" Inherits="app_Invoice_Pay_Status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Invoice By Payment Status</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddStatus" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                                                    <asp:ListItem Value="Matured">Matured Invoices</asp:ListItem>
                                                    <asp:ListItem Value="Immatured">Immature Invoices</asp:ListItem>
                                                    <asp:ListItem Value="Partial">Partial Paid Invoices</asp:ListItem>
                                                    <asp:ListItem Value="LLC">LLC Invoices</asp:ListItem>
                                                    <asp:ListItem Value="Paid">Paid Invoices</asp:ListItem>
                                                </asp:DropDownList>
                            ...
                            <div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="120%" CssClass="table-hover" 
