...
public partial class app_WastageStockConsumption : System.Web.UI.Page
{
    ...
    protected void btnSearch_OnClick(object sender, EventArgs e)
    {
        ...
        string urlx = SQLQuery.ReturnString("Select DefaultLink from Settings_Project where sid=1") + "XerpReports/RptWastageStockConsumption.aspx?dateFrom=" + dt1 + "&dateTo=" + dt2;
