<%@ Page Title="Employee Departments" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="Employee-Department.aspx.cs" Inherits="Operator_Employee_Department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">New Department Setup
                    </h3>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="portlet-body form">
                            <div class="form-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ...
                                    SelectCommand="SELECT [Departmentid], [DepartmentName], [Description] FROM [Departments] ORDER BY [DepartmentName]"></asp:SqlDataSource>
