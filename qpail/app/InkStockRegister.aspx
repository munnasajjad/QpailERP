<%@ Page Title="Ink Stock Summary" Language="C#" MasterPageFile="~/app/MasterPage.master" AutoEventWireup="true" CodeFile="InkStockRegister.aspx.cs" Inherits="app_InkStockRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:UpdatePanel ID="pnl" runat="server">
        <ContentTemplate>
            ...
            <h3 class="page-title">Ink Stock Summary</h3>
                ...
                <div class="col-lg-12">
                    <div class="portlet box green ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>Plastic Finishing Production by Date
                            </div>
                            <div class="tools">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="col-md-4" id="tinPlate" runat="server">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>" SelectCommand="SELECT GradeID, GradeName from ItemGrade where CategoryID='10' ORDER BY [GradeName]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="control-group">
                                                        ...
                                                        <asp:DropDownList ID="ddSpecification" runat="server">
                                                        </asp:DropDownList>
