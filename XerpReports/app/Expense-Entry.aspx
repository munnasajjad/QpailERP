<%@ Page Title="Expense Entry" Language="C#" MasterPageFile="~/app/Layout.Master" AutoEventWireup="true" CodeBehind="Expense-Entry.aspx.cs" Inherits="Oxford.app.Expense_Entry" %>
                ...
                <div>
                    ...
                    <fieldset>
                        ...
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr id="EditField" runat="server" class="hidden">
                                ...
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        ...
                                        ((select name from Class where sl=Expenses.Class)+'-'+(select name from ExpenseHeads where sl=Expenses.ExpHead)) AS text1
                                         FROM [Expenses] order by eid"></asp:SqlDataSource>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label2" runat="server" Text="Expense Date  : "></asp:Label>
                                </td>
                                <td>
                            ...
                            <%--<tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddClass" runat="server" CssClass="form-control"
                                        DataSourceID="SqlDataSource3" DataTextField="name" DataValueField="sl" AutoPostBack="True" OnSelectedIndexChanged="ddClass_OnSelectedIndexChanged">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                        SelectCommand="SELECT [sl], [Name] FROM [ExpenseHeads] WHERE ([GroupID] = @GroupID) ORDER BY [Name]">
                                        <SelectParameters>
                            ...
                            <tr style="background: none">
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="btnClear" type="reset" CssClass="btn btn-s-md btn-primary" runat="server" Text="Clear" OnClick="btnClear_OnClick" />
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                ...
                <div>
                    ...
                    <fieldset>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table-responsive" Width="100%" 
                            AllowSorting="True" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="eid">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ExpGroup" HeaderText="Exp. Group" SortExpression="ExpGroup" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                            ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                            SelectCommand="SELECT eid, ExpDate,(select name from ExpenseTypes where sl=Expenses.ExpGroup) as ExpGroup, 
                            ExpDate,(select name from ExpenseHeads where sl=Expenses.ExpHead) as ExpHead, 
                            Description, Amount 
                             FROM [Expenses] where ExpDate=@ExpDate ORDER BY [eid] DESC"
                            DeleteCommand="DELETE FROM Class WHERE (eid = @eid)">
                            <DeleteParameters>
                                <asp:Parameter Name="eid" />
                            </DeleteParameters>
                            <SelectParameters>
                                <asp:ControlParameter ControlID="txtDate" Name="ExpDate" PropertyName="Text" DbType="DateTime" />
                            </SelectParameters>
                        </asp:SqlDataSource>
