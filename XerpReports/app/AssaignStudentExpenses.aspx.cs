...
{
    public partial class AssaignStudentExpenses : System.Web.UI.Page
    {
            ...
            try
            {
                if (ddStudent.SelectedValue != "")
                {
                    if (btnSave.Text == "Save")
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Name", ddStudent.SelectedValue);
                    ...
                    else
                    {
                        ...
                        cmd2.Parameters.AddWithValue("@Name", ddStudent.SelectedValue);
        ...
        private void EditMode()
        {
            ...
            if (dr.Read())
            {
                ...
                ddStudent.SelectedValue = dr[1].ToString();
