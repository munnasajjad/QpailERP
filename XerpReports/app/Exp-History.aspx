<%@ Page Title="" Language="C#" MasterPageFile="~/app/Layout.Master" AutoEventWireup="true" CodeBehind="Exp-History.aspx.cs" Inherits="Oxford.app.Exp_History" %>
        ...
        <section class="panel">
            ...
            <table>
                <tr class="report">
                    ...
                    <td style="width: 20%;">Expense Group : 
                    ...
                    <td style="width: 20%;">Expense Head : 
                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Date" SortExpression="Date">
                            <ItemTemplate>
                                <asp:Label ID="Label21" runat="server" Text='<%# Bind("ExpDate") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                     
                        <asp:TemplateField HeaderText="Exp. Group" SortExpression="ExpGroup">
                            <ItemTemplate>
                                <asp:Label ID="Label3a" runat="server" Text='<%# Bind("ExpGroup") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Exp.Head" SortExpression="ResellerName">
                            <ItemTemplate>
                                <asp:Label ID="ResellerName" runat="server" Text='<%# Bind("ExpHead") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
