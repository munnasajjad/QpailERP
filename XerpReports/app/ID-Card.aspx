<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/app/Layout.Master" CodeBehind="ID-Card.aspx.cs" Inherits="Oxford.app.ID_Card" %>
        ...
        <section class="panel">
            ...
            <div id="Div2">
                <div>
                    ...
                    <fieldset>
                        <legend>Print Students ID Card</legend>
                        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbStudent" runat="server" CssClass="btn btn-sm btn-default" OnClick="lbStudent_Click">Print Student ID</asp:LinkButton>
                                </td>
                            </tr>
