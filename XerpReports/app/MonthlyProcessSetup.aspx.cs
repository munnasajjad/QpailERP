...
{
    public partial class MonthlyProcessSetup : System.Web.UI.Page
    {
                ...
                try
                {
                    if (ddMonth.SelectedValue != "")
                    {
                        if (btnSave.Text == "Save")
                        {
                            ...
                            cmd.Parameters.AddWithValue("@Name", ddMonth.SelectedValue);
                        ...
                        else
                        {
                            ...
                            cmd2.Parameters.AddWithValue("@Name", ddMonth.SelectedValue);
                            cmd2.Parameters.AddWithValue("@Month", ddMonth.SelectedValue);
