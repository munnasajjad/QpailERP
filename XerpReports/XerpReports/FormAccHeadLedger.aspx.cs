...
{
    public partial class FormAccHeadLedger : System.Web.UI.Page
    {
        ...
        private DataTable dataatble(string head, string dtFrom, string dtTo)
        {
            ...
            if (isLiability == "02")
            {
                ...
                dr1["Dr"] = 0;
                dr1["Cr"] = 0;
                dr1["Balance"] = SQLQuery.FormatBDNumber(currBal);
                dt1.Rows.Add(dr1);
                ...
                dr1["Dr"] = 0;
                dr1["Cr"] = 0;
                dr1["Balance"] = string.Format("{0:N2}", SQLQuery.FormatBDNumber(currBal + opBal));
                dt1.Rows.Add(dr1);
            }
            else
            {
