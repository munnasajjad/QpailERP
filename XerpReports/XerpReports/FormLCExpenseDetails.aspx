<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormLCExpenseDetails.aspx.cs" Inherits="Oxford.XerpReports.FormLCExpenseDetails" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"  EnableDatabaseLogonPrompt="False" PrintMode="ActiveX" HyperlinkTarget="_blank" 
