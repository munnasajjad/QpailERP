...
{
    public partial class FormCurrentStockOthers : System.Web.UI.Page
    {
        ...
        private void LoadGridData()
        {
            ...
            DataTable dtx = BindItemGrid(igodown, ilocation, igroup, subgroup, dateFrom);
            ...
            SQLQuery.LoadrptHeader(dsx, rpt); //For Report Header
            rpt.SetParameterValue("@date", datefield);
