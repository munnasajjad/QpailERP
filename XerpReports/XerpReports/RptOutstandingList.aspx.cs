...
{
    public partial class RptOutstandingList : System.Web.UI.Page
    {
        ...
        private void LoadGridData()
        {
            ...
            rpt.Load(Server.MapPath("CrptOutstandingList.rpt"));
        ...
        private DataTable OutstandingList(string partyId)
        {
            ...
            if (partyId == "O404O")
            {
                ...
                foreach (DataRow drx in dtx.Rows)
                {
                    ...
                    DataTable dtx2 = SQLQuery.ReturnDataTable(@"SELECT SaleID, InvNo, InvDate, SalesMode, CustomerID, CustomerName, DeliveryDate, InvoiceTotal, PayableAmount, DueAmount FROM Sales WHERE (CustomerID = '" + pid + "') AND (IsActive=1) ORDER BY InvDate");
