...
{
    public partial class FormIncomeStatement : System.Web.UI.Page
    {
        ...
        private void LoadGridData()
        {
            ...
            rpt.Load(Server.MapPath("CrptIncomeStatement.rpt"));
            ...
            try
            {
                ...
                foreach (DataRow drx in dtx.Rows)
                {
                    ...
                    if (amt4 != "0.00")
                    {
                        ...
                        InsertPL("Add : Non operating income:", ControlAccountsName, ControlAccountsName, SQLQuery.FormatBDNumber(amt4), "1");
                ...
                if (npbp > 0)
                {
                    ...
                    InsertPL("Equity", ControlAccountsName, "Earnings per share ("+ SQLQuery.FormatBDNumber(noOfShares).Substring(0, SQLQuery.FormatBDNumber(noOfShares).Length-3) + " share)", SQLQuery.FormatBDNumber(earning), "0");
