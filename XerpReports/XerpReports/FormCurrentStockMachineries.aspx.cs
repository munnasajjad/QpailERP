...
{
    public partial class FormCurrentStockMachineries : System.Web.UI.Page
    {
        ...
        private void LoadGridData()
        {
            ...
            rpt.Load(Server.MapPath("CrptCurrentStockMachineries.rpt"));
        ...
        private DataTable BindItemGrid(string godown, string ddLocation, string group, string subGroup, string date)
        {
            ...
            try
            {
                ...
                string query = " FROM Stock WHERE ItemGroup='" + group + "' " + godown + location + subGroup + date;
