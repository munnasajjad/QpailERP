<%@ Page MasterPageFile="~/app/Layout.Master" Language="C#" AutoEventWireup="true" CodeBehind="AssaignOtherExpenses.aspx.cs" Inherits="Oxford.app.AssaignOtherExpenses" %>
...
<div id="Div2">
    ...
    <fieldset>
        <legend>Assign Expense (By Students)</legend>
        <table border="0" class="membersinfo tdfirstright bg-green" width="100%">
            ...
            <tr id="EditField" runat="server" class="hidden">
                <td>Edit Expense od Students</td>
                <td>
            ...
            <tr>
                <td>Student ID</td>
                <td>
                    <asp:DropDownList name="" ID="txtName" runat="server"  AutoPostBack="true"
                        DataSourceID="SqlDataSource3" DataTextField="StudentID" DataValueField="sl" 
                        onselectedindexchanged="DropDownList1_SelectedIndexChanged" >
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:Connection_String %>" 
                        SelectCommand="SELECT [sl], [StudentID] FROM [Students] order by sl">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Class Name</td>
                <td>
                    <asp:Label ID="txtNameNumeric" runat="server" Text="Class"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>Expense Head</td>
                <td>
                    <asp:DropDownList name="" ID="ddClassTeacher" runat="server"  AutoPostBack="true"
            ...
            <tr>
                <td>Amount</td>
                <td>
                    <asp:TextBox ID="txtTutionFee" runat="server"></asp:TextBox>
                </td>
            </tr>
