...
<%@ Page Title="" Language="C#" MasterPageFile="~/app/Layout.Master" AutoEventWireup="true" CodeBehind="Coll-Heads.aspx.cs" Inherits="Oxford.app.Coll_Heads" %>
                ...
                <section class="panel">
                    ...
                    <div id="Div2">
                        <div>
                            ...
                            <fieldset>
                                <legend>Collection Heads</legend>
                                    ...
                                    <tr id="EditField" runat="server" class="hidden">
                                        ...
                                        <td>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                                ...
                                                SelectCommand="SELECT [sl], [Name] FROM [CollectionHeads] order by sl"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                        ...
                        <div>
                            ...
                            <fieldset>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT sl, (Select Name from CollectionTypes where sl=CollectionHeads.GroupID) AS GroupID, Name, Description, Amount FROM [CollectionHeads] WHERE CollectionHeads.GroupID=@GroupID ORDER BY [name]"
                                    DeleteCommand="DELETE FROM CollectionTypes WHERE (sl = @sl)">
                                    <DeleteParameters>
