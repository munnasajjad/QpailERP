<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSalesStatement.aspx.cs" Inherits="Oxford.XerpReports.frmSalesStatement" %>
...
<head runat="server">
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"  EnableDatabaseLogonPrompt="False" PrintMode="ActiveX"
            GroupTreeImagesFolderUrl="" Height="1202px" ToolbarImagesFolderUrl="" ToolPanelView="None" ToolPanelWidth="200px" Width="1104px"/>
