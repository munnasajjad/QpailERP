<%@ Page Title="" Language="C#" MasterPageFile="~/app/Layout.Master" AutoEventWireup="true" CodeBehind="Coll-Group.aspx.cs" Inherits="Oxford.app.Coll_Group" %>
                ...
                <section class="panel">
                    ...
                    <div id="Div2">
                        <div>
                            ...
                            <fieldset>
                                <legend>Collection Groups</legend>
                        ...
                        <div>
                            ...
                            <fieldset>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:Connection_String %>"
                                    SelectCommand="SELECT sl, name, Remark, ReRun FROM [CollectionTypes] ORDER BY [name]"
